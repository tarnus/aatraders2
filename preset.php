...
if ($name == "add")
{
	...
	$template_object->display("master_template/presetadd.tpl");
	include ("footer.php");
	die();
}
...
if ($name == "addcomplete")
{
	...
	$template_object->assign("gotomain", $l_global_mmenu);
	$template_object->display("master_template/presetaddcomplete.tpl");
	include ("footer.php");
	die();
}
...
if ($name == "set")
{
	...
	$template_object->assign("l_pre_save", $l_pre_save);
	$template_object->assign("gotomain", $l_global_mmenu);
	$template_object->display("master_template/presetset.tpl");
	include ("footer.php");
	die();
}
...
if ($name == "change")
{
	...
	$template_object->assign("gotomain", $l_global_mmenu);
	$template_object->display("master_template/presetchange.tpl");
	include ("footer.php");
	die();
}
