<?php require_once('/home/aatrader/public_html/aatrade_beta/backends/template_lite/src/plugins/modifier.string_format.php'); $this->register_modifier("string_format", "tpl_modifier_string_format");  require_once('/home/aatrader/public_html/aatrade_beta/backends/template_lite/src/plugins/modifier.strip.php'); $this->register_modifier("strip", "tpl_modifier_strip");  if ($this->_vars['instantmessagecount'] > 0): ?> 
	<?php echo '
	<style type="text/css">
	...
	<tr>
		<td bgcolor="#990000" width="100%" height="96" align="center" valign="middle">
			...
			<input
				...
				onClick="document.getElementById('frame_instant_message').style.visibility = 'hidden'; "
				>
			</form>
