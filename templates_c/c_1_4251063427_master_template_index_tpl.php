...
<param name="movie" value="templates/master_template/images/aat-title.swf" />
<param name="quality" value="high" />
<param name="bgcolor" value="#000000" />
<embed src="templates/master_template/images/aat-title.swf" quality="high" bgcolor="#000000" width="650" height="300" name="3D Solar System" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
</object>
'; ?>
...
<font color="#49A7DD" size="1" face="Verdana, Arial, Helvetica, sans-serif"><b>[Version <?php echo $this->_vars['version']; ?>]</b></font><br><br></td>
...
<table border="0" align="center">
  <tr onMouseover="ddrivetip('Player Name', 'Enter your Ship Captain\'s name for the selected game to take command of your ship.<br><br>If you are a new player click on the New Player button to be assigned a ship.');" onMouseout="hideddrivetip()">
	...
	<td width="250" background="templates/master_template/images/loginbox.png">
		<p align="center">
...
<a onMouseover=\"ddrivetip('Player Ranking', 'Click to view the player rankings for the <font color=white><b>" . addslashes($gamename[$i]) . "</b></font> game.');\" onMouseout=\"hideddrivetip()\" href=\"ranking.php?game_number=$i\"><img border=\"0\" src=\"templates/master_template/images/ranking_small.gif\"></a>&nbsp;&nbsp;&nbsp;
	<a onMouseover=\"ddrivetip('Game Settings', 'Click to view the game settings for the <font color=white><b>" . addslashes($gamename[$i]) . "</b></font> game.');\" onMouseout=\"hideddrivetip()\" href=\"settings.php?game_number=$i\"><img border=\"0\" src=\"templates/master_template/images/setting_small.gif\"></a><br>
	<a onMouseover=\"ddrivetip('FNN News', 'Click to view the latest FNN News broadcast for the <font color=white><b>" . addslashes($gamename[$i]) . "</b></font> game.');\" onMouseout=\"hideddrivetip()\" href=\"news.php?game_number=$i\" class=\"footer\"><img border=\"0\" src=\"templates/master_template/images/fnnnews_small.gif\"></a></td>
	</tr>
  </table>
<br>  ";
...
<table border="0" align="center">
  <tr>
	...
	<input type="image" name="login" src="templates/master_template/images/login.gif" value="<?php echo $this->_vars['l_login_title']; ?>">
	</td>
</tr>
</table>
<br>
...
<table border="0" align="center">
  <tr>
	<td width="118" align="right"><a onMouseover="ddrivetip('Forum Access', 'Click here to view the Forums provided for this game.');" onMouseout="hideddrivetip()" href="<?php echo $this->_vars['link_forums']; ?>" target="_blank"><img border="0" src="templates/master_template/images/forums.gif"></a></td>
<?php if ($this->_vars['main_site'] != ''): ?>
	 <td width="134" align="right">
	  <a onMouseover="ddrivetip('Web Site', 'Click here to be taken to the Web Site for this game.');" onMouseout="hideddrivetip()" href="<?php echo $this->_vars['main_site']; ?>" target="_blank"><img border="0" src="templates/master_template/images/returntosite.gif"></a>
	 </td>
<?php endif; ?>

<?php if ($this->_vars['serverlist'] != ''): ?>
	 <td width="134" align="right">
	  <a onMouseover="ddrivetip('Server List', 'Click here to view a list of all servers running Alien Assault Traders games.');" onMouseout="hideddrivetip()" href="<?php echo $this->_vars['serverlist']; ?>servers" target="_blank"><img border="0" src="templates/master_template/images/serverlist.gif"></a>
	 </td>
<?php endif; ?>
	<td width="70" align="right"><a onMouseover="ddrivetip('FAQ', 'Click here to view a simple F.A.Q. about the game.');" onMouseout="hideddrivetip()" href="http://wiki.aatraders.com/tiki-index.php?page=Playing+the+Game" target="_blank"><img border="0" src="templates/master_template/images/faq.gif"></a></td>
  </tr>
<tr>
		<td colspan="4" align="center"><a onMouseover="ddrivetip('Contact Admin', 'Click here to send an Email to the Admin of this game.');" onMouseout="hideddrivetip()" href="contact_admin.php" target="_blank"><img border="0" src="templates/master_template/images/contact.gif"><img border="0" src="templates/master_template/images/contact_admin.gif"></a></td>
</tr>
</table>
</form>
</center>
