...
<table border="0" align="center">
  <tr class="tooltip <?php echo '{direction: n; width: 150px; background: #222; color: #ddd;}'; ?>
" title="<b>Player Name</b><br>Enter your Ship Captain's name for the selected game to take command of your ship.<br><br>If you are a new player click on the New Player button to be assigned a ship.">
	...
	<td  style="background: url('templates/master_template/images/loginbox.png') no-repeat;width:255px;height:23px;">
		<p align="center">
		<input type="text" name="character_name" value="<?php echo $this->_vars['character_name']; ?>" size="32" maxlength="30" style="color:#52ACEA; font-weight: bold; background-color:black; text-align:left; border-style:none;width:238px">
		</p>
	</td>
  </tr>
  <tr class="tooltip <?php echo '{direction: n; width: 150px; background: #222; color: #ddd;}'; ?>
"  title="<b>Player Password</b><br>Enter your Ship Captain's password to login to your ships computer systems." >
	<td width="200" height="23"><img border="0" src="templates/master_template/images/password.gif"></td>
	<td  style="background: url('templates/master_template/images/loginbox.png') no-repeat;width:255px;height:23px;">
		<p align="center">
		<input type="password" name="pass" value="<?php echo $this->_vars['password']; ?>" size="32" maxlength="<?php echo $this->_vars['maxlen_password']; ?>" style="color:#52ACEA; font-weight:bold; background-color:black; text-align:left; border-style:none;width:238px">
		</p>
	</td>
  </tr>
 </table>
...
<table border="0" align="center">
  <tr>
	<td width="118" align="right"><a class="tooltip" title="<b>Forum Access</b><br>Click here to view the Forums provided for this game."  href="<?php echo $this->_vars['link_forums']; ?>" target="_blank"><img border="0" src="templates/master_template/images/forums.gif"></a></td>
<?php if ($this->_vars['main_site'] != ''): ?>
	 <td width="134" align="right">
	  <a class="tooltip" title="<b>Web Site</b><br>Click here to be taken to the Web Site for this game"  href="<?php echo $this->_vars['main_site']; ?>" target="_blank"><img border="0" src="templates/master_template/images/returntosite.gif"></a>
	 </td>
<?php endif; ?>

<?php if ($this->_vars['serverlist'] != ''): ?>
	 <td width="134" align="right">
	  <a class="tooltip" title="<b>Server List</b><br>Click here to view a list of all servers running Alien Assault Traders games."  href="<?php echo $this->_vars['serverlist']; ?>servers" target="_blank"><img border="0" src="templates/master_template/images/serverlist.gif"></a>
	 </td>
<?php endif; ?>
...
<?php if ($this->_vars['newscount']):  echo '
<script type="text/javascript">
       $(document).ready(
                function(){
                    $(\'#news\').innerfade({
