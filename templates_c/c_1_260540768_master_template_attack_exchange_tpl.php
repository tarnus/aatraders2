...
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td class="header"><h3><?php echo $this->_vars['target_title']; ?></br>
    	<?php if ($this->_vars['attacktype'] == "planet"): ?>
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/master_template/images/planet" . $this->_vars['titleimage'] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
   		<?php else: ?>
			<img src="templates/master_template/images/<?php echo $this->_vars['titleimage']; ?>.gif" border=0>
		<?php endif; ?>
		<?php if ($this->_vars['isfedbounty'] == 0): ?>
	  		</br></br><b><?php echo $this->_vars['l_by_nofedbounty']; ?></b>
		<?php else: ?>
			</br></br><b><span class="red"><?php echo $this->_vars['l_by_fedbounty2']; ?></span></b>
		<?php endif; ?>
		</h3>
	</td>
  </tr>
<?php if ($this->_vars['attacktype'] == "planet"): ?>
	<?php if ($this->_vars['shipsonplanet'] > 0): ?>
  <tr><td colspan="3" align="center" class="portfooter"><b><u><?php echo $this->_vars['l_cmb_ships_are_landed']; ?></u><br><br><?php echo $this->_vars['l_cmb_engshiptoshipcombat']; ?></b></td></tr>
  <tr><td colspan="3" align="center" class="portfooter">
   	<?php $this->_foreach['foreach1'] = array('total' => count((array)$this->_vars['shiponplanet_list']), 'iteration' => 0);
if (count((array)$this->_vars['shiponplanet_list'])): foreach ((array)$this->_vars['shiponplanet_list'] as $this->_vars['key'] => $this->_vars['item']): $this->_foreach['foreach1']['iteration']++;
 ?>
		<p><b><?php echo $this->_vars['shiponplanet_list'][$this->_vars['key']]; ?></b></p>
	<?php endforeach; endif; ?>
  </td></tr>
	<?php else: ?>
  <tr><td colspan="3" align="center" class="portfooter"><b><u><?php echo $this->_vars['l_cmb_noshipslanded']; ?></u></b></td></tr>
	<?php endif; ?>
<?php endif; ?>
</table>
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
...
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td class="leftBuyColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_beams']; ?></b></br><?php echo $this->_vars['stage2_attacker_energy']; ?></td>
    ...
    <td class="leftColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_shields']; ?></b></br><?php echo $this->_vars['stage2_attacker_shields']; ?></td>
    <td class="rightBuyColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_torps']; ?></b></br><?php echo $this->_vars['stage2_attacker_torps']; ?></td>
   <td class="leftColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_armor']; ?></b></br><?php echo $this->_vars['stage2_attacker_armor']; ?></td>
  </tr>
</table>
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
...
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td class="leftBuyColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_beams']; ?></b></br><?php echo $this->_vars['stage3_attacker_energy']; ?></td>
    <td class="rightBuyColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_fighters']; ?></b></br><?php echo $this->_vars['stage3_attacker_fighters']; ?></td>
    <td class="leftColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_shields']; ?></b></br><?php echo $this->_vars['stage3_attacker_shields']; ?></td>
    <td class="rightBuyColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_torps']; ?></b></br><?php echo $this->_vars['stage3_attacker_torps']; ?></td>
   <td class="leftColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_armor']; ?></b></br><?php echo $this->_vars['stage3_attacker_armor']; ?></td>
  </tr>
</table>
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
  <tr><td colspan="3" align="center" class="portfooter"><b><u><?php echo $this->_vars['l_cmb_torp_exchange']; ?></u></b></td></tr>
  <tr>
    <td class="leftBuyColumn" >
    	<?php $this->_foreach['foreach1'] = array('total' => count((array)$this->_vars['attacker_torp_result']), 'iteration' => 0);
if (count((array)$this->_vars['attacker_torp_result'])): foreach ((array)$this->_vars['attacker_torp_result'] as $this->_vars['key'] => $this->_vars['item']): $this->_foreach['foreach1']['iteration']++;
 ?>
			<p><b><?php echo $this->_vars['attacker_torp_result'][$this->_vars['key']]; ?></b></p>
		<?php endforeach; endif; ?>
	</td>
    <td class="rightBuyColumn" >
    	<?php $this->_foreach['foreach1'] = array('total' => count((array)$this->_vars['target_torp_result']), 'iteration' => 0);
if (count((array)$this->_vars['target_torp_result'])): foreach ((array)$this->_vars['target_torp_result'] as $this->_vars['key'] => $this->_vars['item']): $this->_foreach['foreach1']['iteration']++;
 ?>
			<p><b><?php echo $this->_vars['target_torp_result'][$this->_vars['key']]; ?></b></p>
		<?php endforeach; endif; ?>
	</td>
  </tr>
</table>
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td class="leftBuyColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_beams']; ?></b></br><?php echo $this->_vars['end_attacker_energy']; ?></td>
    ...
    <td class="leftColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_shields']; ?></b></br><?php echo $this->_vars['end_attacker_shields']; ?></td>
    <td class="rightBuyColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_torps']; ?></b></br><?php echo $this->_vars['end_attacker_torps']; ?></td>
   <td class="leftColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_attacker_armor']; ?></b></br><?php echo $this->_vars['end_attacker_armor']; ?></td>
  </tr>
  <tr>
    <td class="leftBuyColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_target_beams']; ?></b></br><?php echo $this->_vars['end_target_beams']; ?></td>
    ...
    <td class="leftColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_target_shields']; ?></b></br><?php echo $this->_vars['end_target_shields']; ?></td>
    <td class="rightBuyColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_target_torps']; ?></b></br><?php echo $this->_vars['end_target_torps']; ?></td>
   <td class="leftColumnMini" nowrap><b><?php echo $this->_vars['l_cmb_target_armor']; ?></b></br><?php echo $this->_vars['end_target_armor']; ?></td>
  </tr>
</table>
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
