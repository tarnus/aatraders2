...
<b><?php echo $this->_vars['l_forums_subject']; ?></b><br><input type='text' name='topictitle' size='40' maxlength='60'><br><br>
...
<?php if ($this->_vars['isadmin'] == 1): ?>
	<input type='radio' name='sticky' value='1' checked><?php echo $this->_vars['l_forums_normaltopic']; ?><br><input type='radio' name='sticky' value='9'><?php echo $this->_vars['l_forums_stickytopic']; ?><br><br>
<?php else: ?> 
