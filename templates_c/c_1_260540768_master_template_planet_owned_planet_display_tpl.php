  ...
  <tr> 
    ...
    <td rowspan="4" align="center" valign="middle"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
        <tr> 
          <td align="center"> 
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/master_template/images/planet" . $this->_vars['planettype'] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?><br>
...
<table width="100%" border="1" cellspacing="0" cellpadding="3" bordercolor="#52ACEA" style="border-color: 52ACEA; border-right-width: thin; border-left-width: thin; border-bottom-width: thin; border-top-width: thin;">
		<tr>
			...
			</td><?php endif; ?><td align="center"><font color="#FFFFFF" style="font-size:11px; font-weight:bold;">&nbsp;</td>
				</tr>
			</table>
<br>
