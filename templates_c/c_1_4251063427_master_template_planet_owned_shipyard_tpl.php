...
function countTotal()
{
	...
	// Then, if its become a null value (type in just a, it would be a blank value. blank is bad.) we set it to zero.
	clean_js()
	var newshipvalue = ';  echo $this->_vars['newshipvalue1'];  echo ';
	var form = document.forms[0];
	var i = form.elements.length;
	while (i > 0)
	{
	...
	+ changeDelta(form.hull_upgrade.value,';  echo $this->_vars['sship_minhull'];  echo ')
	+ changeDelta(form.engine_upgrade.value,';  echo $this->_vars['sship_minengines'];  echo ')
	+ changeDelta(form.power_upgrade.value,';  echo $this->_vars['sship_minpower'];  echo ')
	+ changeDelta(form.fighter_upgrade.value,';  echo $this->_vars['sship_minfighter'];  echo ')
	+ changeDelta(form.sensors_upgrade.value,';  echo $this->_vars['sship_minsensors'];  echo ')
	+ changeDelta(form.beams_upgrade.value,';  echo $this->_vars['sship_minbeams'];  echo ')
	+ changeDelta(form.armor_upgrade.value,';  echo $this->_vars['sship_minarmor'];  echo ')
	+ changeDelta(form.cloak_upgrade.value,';  echo $this->_vars['sship_mincloak'];  echo ')
	+ changeDelta(form.torp_launchers_upgrade.value,';  echo $this->_vars['sship_mintorp_launchers'];  echo ')
	+ changeDelta(form.shields_upgrade.value,';  echo $this->_vars['sship_minshields'];  echo ')
	+ changeDelta(form.ecm_upgrade.value,';  echo $this->_vars['sship_minecm'];  echo ') 
...
<center><font size=2 color=white><b><?php echo $this->_vars['l_ship_welcome']; ?></font></center><p>
  ...
  <tr>
    <td bgcolor="#000000" valign="top" align="center" colspan=2>
		<table cellspacing = "0" cellpadding = "0" border = "0" width="100%">
							<tr bgcolor="black">
								<td width=121 align=center><font size=2 color=white><b><?php echo $this->_vars['l_ship_class']; ?></b></font></td>
								<td colspan=2 width=* align=center><font size=2 color=white><b><?php echo $this->_vars['l_ship_properties']; ?></b></font></TD>
							</tr>
							<?php extract($this->_vars, EXTR_REFS);  
$first = 1;
for($i = 0; $i < $countship; $i++)
{
	echo "<tr bgcolor=\"black\"><td height=100 width=121 align=center valign=middle background = templates/master_template/images/spacer.gif>" .
	...
	if ($first == 1)
	{
		...
		if($currentstorage == "0")
		{
			...
			echo "<table border=0 cellpadding=0 bgcolor=\"black\" width=\"100%\">" .
				 ...
				 "</td><td width=215 height=191 background = templates/master_template/images/spacer.gif align=center ><img src=\"$sship_img.gif\"></td><td>&nbsp;&nbsp;</td></tr>" .
				 "</table>" .
 ...
 ?>
<tr><td align="center" colspan=9><br><br><?php echo $this->_vars['gotomain']; ?><br><br></td></tr>
		</table>
	</td>
  </tr>
</table>
