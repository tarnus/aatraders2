<?php require_once('F:\aatrade\aatrade\backends\template_lite\src\plugins\function.math.php'); $this->register_function("math", "tpl_function_math"); ?><H1><?php echo $this->_vars['title']; ?></H1>

<table width="80%" border="1" cellspacing="0" cellpadding="4" align="center">
<TR BGCOLOR='#585980'>
<TH COLSPAN=2 NOWRAP><FONT COLOR=yellow><?php echo $this->_vars['l_shout_title2']; ?></FONT></TH>
</TR>
  <tr>
	...
	<TR>
		<td align="left" width="33%">
			<?php if ($this->_vars['currentpage'] != 1): ?>
				<a href="shoutbox.php?page=<?php echo $this->_vars['previouspage']; ?>"><?php echo $this->_vars['l_shout_prev']; ?></a>
			<?php else: ?>
				&nbsp;
			<?php endif; ?>
		</td>
	...
	&nbsp;<input type="submit" value="<?php echo $this->_vars['l_submit']; ?>">
		...
		<td align="right" width="33%">
			<?php if ($this->_vars['currentpage'] != $this->_vars['totalpages']): ?>
				<a href="shoutbox.php?page=<?php echo $this->_vars['nextpage']; ?>"><?php echo $this->_vars['l_shout_next']; ?></a>
			<?php else: ?>
				&nbsp;
			<?php endif; ?>
		</td>
...
<tr><td align="center"><a href="shoutbox.php"><?php echo $this->_vars['l_shout_refresh']; ?></a>&nbsp;&nbsp;&nbsp;<a href="javascript:window.close();"><?php echo $this->_vars['l_shout_close']; ?></a>
</td></tr>
		</table>
	</td>
  </tr>
