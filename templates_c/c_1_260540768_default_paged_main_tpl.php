...
<TR align="center"><TD><img src="images/avatars/<?php echo $this->_vars['avatar']; ?>"></td></tr>
		<?php endif; ?>
<tr><td class=normal><?php echo $this->_vars['l_rank']; ?>: <img src="templates/default_paged/images/rank/<?php echo $this->_vars['insignia']; ?>"></td></tr>
...
<tr><td align="center" colspan=2><span class=mnu><?php echo $this->_vars['shoutboxtitle']; ?></span><br><br></td></tr>
	<tr><td>
      ...
      <table width="50%" border="0" cellspacing="3" cellpadding="3" align="<?php extract($this->_vars, EXTR_REFS);   echo ($countplanet > 0) ? "right" : "center"; ?>">
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 3): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_paged/images/planet" . $this->_vars['planetimg'][3] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
	...
	<?php endif; ?>
        ...
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 1): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_paged/images/planet" . $this->_vars['planetimg'][1] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
        ...
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 0): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_paged/images/planet" . $this->_vars['planetimg'][0] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
        ...
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 2): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_paged/images/planet" . $this->_vars['planetimg'][2] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
		  ...
		  <?php if ($this->_vars['countplanet'] > 4): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_paged/images/planet" . $this->_vars['planetimg'][4] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
		...
		<?php if ($this->_vars['playercount'] != 0): ?>
			<?php for($for1 = 0; ((0 < $this->_vars['playercount']) ? ($for1 < $this->_vars['playercount']) : ($for1 > $this->_vars['playercount'])); $for1 += ((0 < $this->_vars['playercount']) ? 1 : -1)):  $this->assign('myLoop', $for1); ?>
   				<?php if ($this->_vars['shipprobe'][$this->_vars['myLoop']] == "ship"): ?>
					...
					<img src="templates/default_paged/images/<?php echo $this->_vars['shipimage'][$this->_vars['myLoop']]; ?>.gif" border=0></a><BR>
...
<tr><td align="center" colspan=2><span class=mnu><?php echo $this->_vars['l_cargo']; ?></span><br><br></td></tr>
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_energy']; ?>" src="templates/default_paged/images/energy.png">&nbsp;<?php echo $this->_vars['l_energy']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_fighters']; ?>" src="templates/default_paged/images/tfighter.png">&nbsp;<?php echo $this->_vars['l_fighters']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_torps']; ?>" src="templates/default_paged/images/torp.png">&nbsp;<?php echo $this->_vars['l_torps']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_armorpts']; ?>" src="templates/default_paged/images/armor.png">&nbsp;<?php echo $this->_vars['l_armor']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_credits']; ?>" src="templates/default_paged/images/credits.png">&nbsp;<?php echo $this->_vars['l_credits']; ?></td><td width="50%" nowrap align='right' colspan=2><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td align="center" colspan=2><span class=mnu><?php echo $this->_vars['l_realspace']; ?></span><br><br></td></tr>
...
<tr><td align="center" colspan=2><span class=mnu><?php echo $this->_vars['l_main_warpto']; ?></span><br><br></td></tr>
<div class=mnu>
<?php extract($this->_vars, EXTR_REFS);  
	if(count($links) == 0)
...
<?php endif; ?>
<img src="templates/default_paged/images/<?php echo $this->_vars['startypes']; ?>.gif" border="0" alt="" style="position: absolute; z-index:-1; left: 70%; top: 30%; width: 480px; height: 480px; margin-left: -240px; margin-top: -240px;">
