...
<table border=1 cellspacing=1 cellpadding=2 width="720" align=center bgcolor="#000000">
	...
	<tr align=center bgcolor="#400040">
		<td width="50%" valign="top">
			...
			<img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="100%" height="4" alt="px" />
			<img src="templates/<?php echo $this->_vars['templatename']; ?>images/white_dot.gif" width="50%" height="1" alt="px" /><br>
			<img src="templates/<?php echo $this->_vars['templatename']; ?>images/spacer.gif" width="100%" height="7" alt="px" />
