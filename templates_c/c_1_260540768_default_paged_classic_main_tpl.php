...
<?php endif; ?>
<div style="background: no-repeat top  right url(templates/default_paged_classic/images/<?php echo $this->_vars['startypes']; ?>.gif) ;vertical-align: top; text-align: left; /*border: 1px solid white;*/">
...
<TR align="center"><TD><img src="images/avatars/<?php echo $this->_vars['avatar']; ?>"></td></tr>
		<?php endif; ?>
<tr><td class=normal><?php echo $this->_vars['l_rank']; ?>: <img src="templates/default_paged_classic/images/rank/<?php echo $this->_vars['insignia']; ?>"></td></tr>
...
<?php if ($this->_vars['allow_probes'] == 1):  echo $this->_vars['commandprobe']; ?><br>
<?php endif;  if ($this->_vars['galaxy_map_enabled'] == true): ?>
	<?php echo $this->_vars['commandmap']; ?><br>
	<?php echo $this->_vars['commandlocalmap']; ?><br>
<?php endif;  if ($this->_vars['enable_spies'] != 0): ?>
	<?php echo $this->_vars['commandspy']; ?><br>
<?php endif; ?>

<?php if ($this->_vars['enable_dignitaries'] != 0): ?>
	<?php echo $this->_vars['commanddig']; ?><br>
<?php endif;  echo $this->_vars['commandlog']; ?><br>
...
<?php endif;  echo $this->_vars['commanddestruct']; ?><br>
...
<?php endif;  extract($this->_vars, EXTR_REFS);  
	for($i = 0; $i < $newcommands; $i++){
		echo $newcommandfull[$i]."<br>";
	}
  if ($this->_vars['tournament_mode'] == 0): ?>
	<?php echo $this->_vars['commandlogout'];  endif; ?>
<br></div>
</td></tr>
</table>
	</td>
...
<td align=right width="33%"><a class=nav_title_14b href="zoneinfo.php"><b><?php echo $this->_vars['zonename']; ?></b></a>&nbsp;</td>
</tr>
      ...
      <table width="50%" border="0" cellspacing="3" cellpadding="3" align="<?php extract($this->_vars, EXTR_REFS);   echo ($countplanet > 0) ? "right" : "center"; ?>">
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 3): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_paged_classic/images/planet" . $this->_vars['planetimg'][3] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
	...
	<?php endif; ?>
        ...
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 1): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_paged_classic/images/planet" . $this->_vars['planetimg'][1] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
        ...
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 0): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_paged_classic/images/planet" . $this->_vars['planetimg'][0] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
        ...
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 2): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_paged_classic/images/planet" . $this->_vars['planetimg'][2] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
		  ...
		  <?php if ($this->_vars['countplanet'] > 4): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_paged_classic/images/planet" . $this->_vars['planetimg'][4] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
		...
		<?php if ($this->_vars['playercount'] != 0): ?>
			<?php for($for1 = 0; ((0 < $this->_vars['playercount']) ? ($for1 < $this->_vars['playercount']) : ($for1 > $this->_vars['playercount'])); $for1 += ((0 < $this->_vars['playercount']) ? 1 : -1)):  $this->assign('myLoop', $for1); ?>
   				<?php if ($this->_vars['shipprobe'][$this->_vars['myLoop']] == "ship"): ?>
					...
					<img src="templates/default_paged_classic/images/<?php echo $this->_vars['shipimage'][$this->_vars['myLoop']]; ?>.gif" border=0></a><BR>
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_energy']; ?>" src="templates/default_paged_classic/images/energy.png">&nbsp;<?php echo $this->_vars['l_energy']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_fighters']; ?>" src="templates/default_paged_classic/images/tfighter.png">&nbsp;<?php echo $this->_vars['l_fighters']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_torps']; ?>" src="templates/default_paged_classic/images/torp.png">&nbsp;<?php echo $this->_vars['l_torps']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_armorpts']; ?>" src="templates/default_paged_classic/images/armor.png">&nbsp;<?php echo $this->_vars['l_armor']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_credits']; ?>" src="templates/default_paged_classic/images/credits.png">&nbsp;<?php echo $this->_vars['l_credits']; ?></td><td width="50%" nowrap align='right' colspan=2><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
