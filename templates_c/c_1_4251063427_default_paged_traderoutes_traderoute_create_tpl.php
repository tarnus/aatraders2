  ...
  <tr>
	...
	<table width="100%"  border="0">
      ...
      <tr>
        ...
        <td>
          <input onBlur="makeSourceRequest();" type=text name=port_id1 size=20 align=center value="<?php echo $this->_vars['shipsector']; ?>"></td>
        <td id="source">&nbsp;</td>
      </tr>
      <tr>
...
for ($i=0; $i < $commodity_item_count; $i++)
{
 ...
 ?>
      ...
      <tr>
        ...
        <td><input type=radio name="ptype1" value="team_planet" onclick="PopulateSourceTeamPlanet();"></td>
...
for ($i=0; $i < $commodity_item_count; $i++)
{
 ...
 ?>
      ...
      <tr>
        <td><?php echo $this->_vars['l_team']; ?> <?php echo $this->_vars['l_tdr_planet']; ?> : </td>
        <td><input type=radio name="ptype2" value="team_planet" onclick="PopulateDestTeamPlanet();"></td>
