 ...
 ?>
										<td align="center" valign="top">
											<?php if ($this->_vars['planetbounty'][$this->_vars['key']] > 0): ?>
												<font color='red' size='4'><b><?php echo $this->_vars['l_by_bountyscan']; ?></b></font></br>
											<?php endif; ?>
		...
		<td valign="top"><b><?php echo $this->_vars['l_sn_addnote']; ?></b><br>
			...
			<TR BGCOLOR="<?php echo $this->_vars['color_header']; ?>" VALIGN="top">
				...
				<TR BGCOLOR="<?php echo $this->_vars['color_header']; ?>" VALIGN="top">
					...
					<td>&nbsp;</td>
					<TD ALIGN="left"><font size="2"><input type="Text" name="port" width="10" value="<?php echo $this->_vars['port_type']; ?>">&nbsp;</font></TD>
				</tr>
				<TR BGCOLOR="<?php echo $this->_vars['color_header']; ?>" VALIGN="top">
