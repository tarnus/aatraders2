...
function makeAutorouteSTPRequest()
{
	var form = document.forms[0];
	planetid = form.team_planet_id1.value;
...
function makeAutorouteDTPRequest()
{
	var form = document.forms[0];
	planetid = form.team_planet_id2.value;
...
function PopulateSourceTeamPlanet() {
   ...
   if (planetspecialteam[planet_id1_item[planet_id1_item.selectedIndex].value] != \'\') {
      AddToOptionList(document.frmMain.source_planet_commodity, planetspecialteam[planet_id1_item[planet_id1_item.selectedIndex].value], planetspecialteam[planet_id1_item[planet_id1_item.selectedIndex].value]);
   }
}

function PopulateDestTeamPlanet() {
   ...
   if (planetspecialteam[planet_id2_item[planet_id2_item.selectedIndex].value] != \'\') {
      AddToOptionList(document.frmMain.destination_planet_commodity, planetspecialteam[planet_id2_item[planet_id2_item.selectedIndex].value], planetspecialteam[planet_id2_item[planet_id2_item.selectedIndex].value]);
   }
}
...
for ($i=0; $i < $commodity_item_count; $i++)
{
 ...
 ?>
      ...
      <tr>
        ...
        <td><input type=radio name="ptype1" value="team_planet" onclick="PopulateSourceTeamPlanet(); makeAutorouteSPRequest();"></td>
        <td><select name="team_planet_id1" onChange="PopulateSourceTeamPlanet(); makeAutorouteSTPRequest();">
...
for ($i=0; $i < $commodity_item_count; $i++)
{
 ...
 ?>
      ...
      <tr>
        <td><?php echo $this->_vars['l_team']; ?> <?php echo $this->_vars['l_tdr_planet']; ?> : </td>
        <td><input type=radio name="ptype2" value="team_planet" onclick="PopulateDestTeamPlanet(); makeAutorouteDPRequest();"></td>
        <td><select name="team_planet_id2" onChange="PopulateDestTeamPlanet(); makeAutorouteDTPRequest();">
