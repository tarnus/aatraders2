...
<?php if ($this->_vars['team_join_count'] < $this->_vars['max_team_changes']): ?>
	<?php if ($this->_vars['playerteam'] <> 0): ?>
		<?php echo $this->_vars['l_team_leavefirst']; ?><BR>
	<?php else: ?>
		<?php if ($this->_vars['isplayerteaminvite']): ?>
			<?php echo $this->_vars['l_team_welcome']; ?> <B><?php echo $this->_vars['teamname']; ?></B>.<BR><BR>
		<?php else: ?>
			<?php echo $this->_vars['l_team_noinviteto']; ?><BR>
		<?php endif; ?>
	<?php endif; ?>
<?php else: ?>
	<?php echo $this->_vars['l_team_cantjoin']; ?>
<?php endif; ?>
