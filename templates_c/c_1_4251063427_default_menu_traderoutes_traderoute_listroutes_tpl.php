...
<tr bgcolor="#585980"><td align="center" colspan=8><b><?php echo $this->_vars['l_tdr_curtdr']; ?></b></td></tr>
<tr align=center bgcolor="#585980">
<td><b><?php echo $this->_vars['l_tdr_src']; ?></b></td>
<td><b><?php echo $this->_vars['l_tdr_srctype']; ?></b></td>
<td><b><?php echo $this->_vars['l_tdr_dest']; ?></b></td>
<td><b><?php echo $this->_vars['l_tdr_desttype']; ?></b></td>
<td><b><?php echo $this->_vars['l_tdr_move']; ?></b></td>
<td><b><?php echo $this->_vars['l_tdr_circuit']; ?></b></td>
<td><b><?php echo $this->_vars['l_tdr_change']; ?></b></td>
<td><b><?php echo $this->_vars['l_tdr_del']; ?></b></td>
</tr>
...
<?php extract($this->_vars, EXTR_REFS);  
 ...
 ?>
<tr bgcolor="#23244F">
	<td colspan="7">&nbsp;</td><td align="center"><?php echo $this->_vars['l_tdr_galaxytrades']; ?><br><br><INPUT TYPE=SUBMIT VALUE="<?php echo $this->_vars['l_tdr_del']; ?>"></td>
</tr>
</table></FORM>
</td></tr>
<tr><td><br><?php echo $this->_vars['l_tdr_newtdr']; ?>
</td></tr>
