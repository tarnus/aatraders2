...
<?php endif; ?>
	...
	<li><a href="report.php"><?php echo $this->_vars['l_reports']; ?></a>
		<ul>
			...
			<ul>
				<li><a href="planet_report.php?commandpage=commodities"><?php echo $this->_vars['l_planetstatus']; ?></a></li>
				<li><a href="planet_report.php?commandpage=defenses"><?php echo $this->_vars['l_planetdefenses']; ?></a></li>
				<li><a href="planet_report.php?commandpage=production_view"><?php echo $this->_vars['l_changeproduction']; ?></a></li>
			</ul>
			</li>
...
<div style="background: no-repeat top  right url(templates/default_menu/images/<?php echo $this->_vars['startypes']; ?>.gif) ;vertical-align: top; text-align: left; /*border: 1px solid white;*/">
<table width="100%" cellpadding=0 cellspacing=0 border=0 align=center>
<tr>
<td>&nbsp;</td>
<td>
...
<tr><td class=normal><?php echo $this->_vars['l_rank']; ?>: <img src="templates/default_menu/images/rank/<?php echo $this->_vars['insignia']; ?>"></td></tr>
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_energy']; ?>" src="templates/default_menu/images/energy.png">&nbsp;<?php echo $this->_vars['l_energy']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_fighters']; ?>" src="templates/default_menu/images/tfighter.png">&nbsp;<a href=defense_deploy.php><?php echo $this->_vars['l_fighters']; ?></a></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_torps']; ?>" src="templates/default_menu/images/torp.png">&nbsp;<a href=defense_deploy.php><?php echo $this->_vars['l_torps']; ?></a></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_armorpts']; ?>" src="templates/default_menu/images/armor.png">&nbsp;<?php echo $this->_vars['l_armor']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_credits']; ?>" src="templates/default_menu/images/credits.png">&nbsp;<?php echo $this->_vars['l_credits']; ?></td><td width="50%" nowrap align='right' colspan=2><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<?php elseif ($this->_vars['num_traderoutes'] == 1):  extract($this->_vars, EXTR_REFS);  
echo "<tr><td class=\"nav_title_12\">&nbsp;<a class=mnu href=traderoute_engage.php?engage=" . $traderoute_links[0] . ">" . $traderoute_display[0] . "</a><br>&nbsp;</td><tr>";
  else:  extract($this->_vars, EXTR_REFS);  
...
<a class=mnu href="javascript:OpenSB()"><?php echo $this->_vars['shoutboxtitle']; ?></a>
  ...
  <tr>
	...
	<input type="Text" name="sbt"  class="shoutform" size="20" maxlength="250" onfocus="document.onkeypress = null;" ONBLUR="document.onkeypress = getKey;" ><input type="submit" name="go" value="Go" class="shoutform"><br><?php echo $this->_vars['l_public']; ?>&nbsp;
...
<?php if ($this->_vars['countplanet'] != 0):  for($for1 = 0; ((0 < $this->_vars['countplanet']) ? ($for1 < $this->_vars['countplanet']) : ($for1 > $this->_vars['countplanet'])); $for1 += ((0 < $this->_vars['countplanet']) ? 1 : -1)):  $this->assign('i', $for1); ?>
	<td align=center valign=top>
	<A HREF=planet.php?planet_id=<?php echo $this->_vars['planetid'][$this->_vars['i']]; ?>>
	<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/default_menu/images/planet" . $this->_vars['planetimg'][$this->_vars['i']] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
		...
		<?php if ($this->_vars['playercount'] != 0): ?>
			<?php for($for1 = 0; ((0 < $this->_vars['playercount']) ? ($for1 < $this->_vars['playercount']) : ($for1 > $this->_vars['playercount'])); $for1 += ((0 < $this->_vars['playercount']) ? 1 : -1)):  $this->assign('myLoop', $for1); ?>
   				<?php if ($this->_vars['shipprobe'][$this->_vars['myLoop']] == "ship"): ?>
					...
					<img src="templates/default_menu/images/<?php echo $this->_vars['shipimage'][$this->_vars['myLoop']]; ?>.gif" border=0></a><BR>
...
<?php endif;  if ($this->_vars['lastsectors'][1] != ""): ?>
...
<?php endif;  if ($this->_vars['lastsectors'][2] != ""): ?>
...
<?php endif;  if ($this->_vars['lastsectors'][3] != ""): ?>
...
<?php endif;  if ($this->_vars['lastsectors'][4] != ""): ?>
