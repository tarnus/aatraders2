<tr><td><FORM ACTION="<?php echo $this->_vars['returnlink']; ?>" METHOD="POST"  enctype="multipart/form-data">
...
<input type=hidden name=count value=<?php echo $this->_vars['count']; ?>>
<input type="hidden" name="game_number" value="<?php echo $this->_vars['game_number']; ?>">
<input type=hidden name=admin_password value=<?php echo $this->_vars['admin_password']; ?>>
