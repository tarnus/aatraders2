<?php require_once('/home/aatrader/public_html/aatrade_beta/backends/template_lite/src/plugins/function.math.php'); $this->register_function("math", "tpl_function_math"); ?><H1><?php echo $this->_vars['title']; ?>: <?php echo $this->_vars['l_pr_production']; ?></H1>
<?php echo '
