...
<input type="Hidden" name="port_name" value="<?php echo $this->_vars['sector_port']; ?>">
<input type="Hidden" name="port" value="<?php echo $this->_vars['sector_port']; ?>">
...
<TABLE BORDER=0 CELLSPACING=0 CELLPADDING=2>
	<TR BGCOLOR="<?php echo $this->_vars['color_header']; ?>" VALIGN=top>
		...
		<TD ALIGN=left><font size=2><B><?php echo $this->_vars['shipgalaxyname']; ?>&nbsp;</B></font></TD>
	</tr>
	<TR BGCOLOR="<?php echo $this->_vars['color_header']; ?>" VALIGN=top>
		<TD ALIGN=left><font size=2><B>&nbsp;<?php echo $this->_vars['l_sn_notedate']; ?>&nbsp;</B></font></TD><td width="5">&nbsp;</td>
		<TD ALIGN=left><font size=2><B><?php echo $this->_vars['dateposted']; ?>&nbsp;</B></font></TD>
	</tr>
	<TR BGCOLOR="<?php echo $this->_vars['color_header']; ?>" VALIGN=top>
		<TD ALIGN=left><font size=2><B>&nbsp;<?php echo $this->_vars['l_sn_hdsector']; ?>&nbsp;</B></font></TD><td width="5">&nbsp;</td>
		<TD ALIGN=left><font size=2><b><?php echo $this->_vars['sector']; ?>&nbsp;</b></font></TD>
	</tr>
	<TR BGCOLOR="<?php echo $this->_vars['color_header']; ?>" VALIGN=top>
		<TD ALIGN=left><font size=2><B>&nbsp;<?php echo $this->_vars['l_sn_hdport']; ?>&nbsp;</B></font></TD><td>&nbsp;</td>
		<TD ALIGN=left><font size=2><b><?php echo $this->_vars['sector_port']; ?>&nbsp;</b></font></TD>
	</tr>
	<TR BGCOLOR="<?php echo $this->_vars['color_header']; ?>" VALIGN=top>
	...
	<TR BGCOLOR="<?php echo $this->_vars['color_header']; ?>" VALIGN=top>
		...
		<?php endif; ?>	
        <?php if ($this->_vars['sector_type'] == "Worm Hole"): ?>
            <option value="Worm Hole" selected><?php echo $this->_vars['l_wormhole']; ?></option>
        <?php else: ?>
            <option value="Worm Hole"><?php echo $this->_vars['l_wormhole']; ?></option>
        <?php endif; ?>    
		</select>&nbsp;</font></TD>
	</tr>
