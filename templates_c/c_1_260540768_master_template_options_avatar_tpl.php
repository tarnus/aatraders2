...
<tr><td align=center width=600><span class=mnu><?php echo $this->_vars['l_opt_currentavatar']; ?></span></td></tr><tr><td align=center width=600><img src="images/avatars/<?php echo $this->_vars['currentavatar']; ?>"><br><br></td></tr>
<?php if ($this->_vars['allow_avatar_upload'] == 1): ?>
	<tr><td align=center width=600><span class=mnu><?php echo $this->_vars['l_opt_uploadavatar']; ?></span></td></tr>
	<tr><td align=center width=600><INPUT TYPE="file" NAME="img_src" ></td></tr>
	<tr><td align=center width=600><span class=mnu><?php echo $this->_vars['l_opt_uploadtypes']; ?></span></td></tr>
	<tr><td align=center width=600><input type="submit" value="<?php echo $this->_vars['l_opt_uploadavatar']; ?>"><br><br></td></tr>
<?php endif; ?>
</form>
</table>
				</td>
...
<table width="80%" border="1" cellspacing="0" cellpadding="4" align="center">
  <tr>
    <td bgcolor="#000000" valign="top" align="center" colspan=2>
		<table cellspacing = "0" cellpadding = "0" border = "0" width="100%">
<form action="options_avatar.php" METHOD=POST enctype="multipart/form-data">
<tr><td align=center width=600><span class=mnu><?php echo $this->_vars['l_opt_directory']; ?></span><select name=gallery>
...
<br><br><input type="submit" value="<?php echo $this->_vars['l_opt_change']; ?>"><br><br></td><tr>
</form></table>

<form action="options_avatar.php" METHOD=POST enctype="multipart/form-data">
<input type="hidden" name="action" value="selectgraphic">
<input type="hidden" name="gallery" value="<?php echo $this->_vars['gallery']; ?>">
...
<tr><td colspan=10><br><br><?php echo $this->_vars['gotomain']; ?><br><br></td></tr>
		</table>
	</td>
  </tr>
</table>
