...
<?php if ($this->_vars['allow_probes'] == 1):  echo '
key[\'P\'] = "probes.php"; 
'; ?>
...
<?php endif;  if ($this->_vars['enable_dignitaries'] == 1): ?>
			<li><a href="dig.php"><?php echo $this->_vars['l_dig']; ?></a></li>
<?php endif;  if ($this->_vars['allow_probes'] == 1): ?>
...
<?php endif;  if ($this->_vars['tournament_mode'] == 0): ?>
...
<TR align="center"><TD><img src="images/avatars/<?php echo $this->_vars['avatar']; ?>"></td></tr>
		<?php endif; ?>
<tr><td class=normal><?php echo $this->_vars['l_rank']; ?>: <img src="templates/windowed_menu/images/rank/<?php echo $this->_vars['insignia']; ?>"></td></tr>
...
<?php if ($this->_vars['cargo_items'] > 0):  extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_energy']; ?>" src="templates/windowed_menu/images/energy.png">&nbsp;<?php echo $this->_vars['l_energy']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_fighters']; ?>" src="templates/windowed_menu/images/tfighter.png">&nbsp;<?php echo $this->_vars['l_fighters']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_torps']; ?>" src="templates/windowed_menu/images/torp.png">&nbsp;<?php echo $this->_vars['l_torps']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_armorpts']; ?>" src="templates/windowed_menu/images/armor.png">&nbsp;<?php echo $this->_vars['l_armor']; ?></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="<?php echo $this->_vars['l_credits']; ?>" src="templates/windowed_menu/images/credits.png">&nbsp;<?php echo $this->_vars['l_credits']; ?></td><td width="50%" nowrap align='right' colspan=2><span class=mnu>&nbsp;
<?php extract($this->_vars, EXTR_REFS);  
...
<?php if ($this->_vars['num_traderoutes'] > 1):  extract($this->_vars, EXTR_REFS);  
...
<?php if ($this->_vars['xyminusp'][8] != ""): ?>
	...
	<?php endif;  if ($this->_vars['xyminusp'][6] != ""): ?>
	...
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif;  if ($this->_vars['xyminusp'][4] != ""): ?>
...
<?php if ($this->_vars['xyplus'][4] != ""): ?>
	...
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif;  if ($this->_vars['xyplus'][6] != ""): ?>
...
<?php if ($this->_vars['xyminusp'][7] != ""): ?>
	...
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif;  if ($this->_vars['xyminusp'][3] != ""): ?>
...
<?php if ($this->_vars['xyminusp'][5] != ""): ?>
	...
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif;  if ($this->_vars['xyminusp'][2] != ""): ?>
...
<?php if ($this->_vars['xyminus'][2] != ""): ?>
	...
	<?php else: ?>
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	<?php endif;  if ($this->_vars['xyminus'][0] != ""): ?>
      ...
      <table width="50%" border="0" cellspacing="3" cellpadding="3" align="<?php extract($this->_vars, EXTR_REFS);   echo ($countplanet > 0) ? "right" : "center"; ?>">
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 3): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/windowed_menu/images/planet" . $this->_vars['planetimg'][3] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
	...
	<?php endif; ?>
        ...
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 1): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/windowed_menu/images/planet" . $this->_vars['planetimg'][1] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
        ...
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 0): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/windowed_menu/images/planet" . $this->_vars['planetimg'][0] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
        ...
        <tr> 
		  ...
		  <?php if ($this->_vars['countplanet'] > 2): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/windowed_menu/images/planet" . $this->_vars['planetimg'][2] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
		  ...
		  <?php if ($this->_vars['countplanet'] > 4): ?>
			...
			<?php echo $this->_run_insert(array('name' => "img", 'src' => "templates/windowed_menu/images/planet" . $this->_vars['planetimg'][4] . ".png", 'alt' => "", 'width' => "100", 'height' => "100")); ?>
			</a><BR>
...
<img src="templates/windowed_menu/images/<?php echo $this->_vars['startypes']; ?>.gif" border="0" alt="" style="position: absolute; z-index:-1; left: 90%; top: 30%; margin-left: -240px; margin-top: -140px;">
		...
		<?php if ($this->_vars['playercount'] != 0): ?>
			<?php for($for1 = 0; ((0 < $this->_vars['playercount']) ? ($for1 < $this->_vars['playercount']) : ($for1 > $this->_vars['playercount'])); $for1 += ((0 < $this->_vars['playercount']) ? 1 : -1)):  $this->assign('myLoop', $for1); ?>
   				<?php if ($this->_vars['shipprobe'][$this->_vars['myLoop']] == "ship"): ?>
					...
					<img src="templates/windowed_menu/images/<?php echo $this->_vars['shipimage'][$this->_vars['myLoop']]; ?>.gif" border=0></a><BR>
