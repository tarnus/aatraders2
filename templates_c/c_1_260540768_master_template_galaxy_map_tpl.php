...
<?php if ($this->_vars['pages'] != 0): ?>
		<table cellspacing = "0" cellpadding = "0" border = "0" width="100%">
										<form action="galaxy_map.php" method="post">
								<tr>
	<TD align="right">
	<?php echo $this->_vars['l_common_selectpage']; ?>:
...
<?php if ($this->_vars['mapsectorcount'] == 0): ?>
<tr><td><div align="center"><font color="lime"><b><?php echo $this->_vars['l_glxy_nosectors']; ?></b></font></div>
<?php endif; ?>
<?php extract($this->_vars, EXTR_REFS);  
...
for($i = 0; $i < $mapsectorcount; $i++){
	...
	if($sectorid[$i] >= $startsector and $sectorid[$i] < $endsector){
		...
		echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_list[$i]<br><br>$l_links:<br>$linklist<br>$notelistnote[$i] $teamnotelistnote[$i]'); \" onMouseout=\"hideddrivetip();\"><img src=\"images/ports/" . $sectorimage[$i] . ".png\" title=\"$sectortitle[$i]\" border=0></A></TD>\n";
          $mycount++;
           $cols=$map_width-$mycount+1;
		if ($break == 0)
		{
           
			echo "<TD   colspan='".$cols."'>$sectorname[$i]</TD></TR>\n";
		}
...
if($break != 0)
{
	echo"<TD  colspan='".$cols."' align='right'>" . $sectorname[($i-1)] . "&nbsp;</TD>";
}
 ?>
				</td>
			</tr>
...
<tr><td><div align="center"><?php echo $this->_vars['gotomain']; ?><div></td></tr>
</table>
<br>
<table width="600" border="1" cellspacing="0" cellpadding="4" align="center" bgcolor="#000000">
<tr><td colspan="3"><div align="center"><b><font size="2" color="lime"><?php echo $this->_vars['l_commodities']; ?></font></b></div></td></tr>
<TR>
<?php extract($this->_vars, EXTR_REFS);  
	for($i = 0; $i < $typecount; $i++)
	{
echo "<td class=\"footer\"><img src=\"images/ports/" . $porttypes[$i] . ".png\"> - " . $porttypes_name[$i] . "</td>";
...
echo"</tr>";
 ?>
<tr><td colspan="3"><div align="center"><?php echo $this->_vars['gotomain']; ?><div></td></tr>
</table>
<br>
<table width="600" border="1" cellspacing="0" cellpadding="4" align="center" bgcolor="#000000">
<tr><td colspan="6"><div align="center"><b><font size="2" color="lime"><?php echo $this->_vars['l_player']; ?></font></b></div></td></tr>
<tr>
<?php extract($this->_vars, EXTR_REFS);  
for($i = 1; $i < $player_count; $i++){
	echo "<td class=\"footer\" bgcolor=".$playerzonecolor[$i]."><img src = \"templates/master_template/images/spacer.gif\" width=12></td><td class=\"footer\">".$playerzone[$i]."&nbsp;</td>";
...
if(($i-1)/3 != floor(($i-1)/3) && $i == $player_count)
{
	...
	echo"</tr>";
 ?>
<tr><td colspan=6><div align="center"><?php echo $this->_vars['gotomain']; ?><div></td></tr>

</table>
<br>
<table width="600" border="1" cellspacing="0" cellpadding="4" align="center" bgcolor="#000000">
<tr><td colspan="6"><div align="center"><b><font size="2" color="lime"><?php echo $this->_vars['l_teams']; ?></font></b></div></td></tr>
<tr>
<?php extract($this->_vars, EXTR_REFS);  
for($i = 1; $i < $teamzonecount; $i++){
	echo "<td class=\"footer\" bgcolor=".$namezonecolor[$i]."><img src = \"templates/master_template/images/spacer.gif\" width=12></td><td class=\"footer\">".$namezone[$i]."&nbsp;</td>";
