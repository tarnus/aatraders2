...
<table width="90%" border="1" cellspacing="0" cellpadding="4" align="center">
  <tr>
    <td bgcolor="#000000" valign="top" align="center" colspan=2>
		...
		<TR BGCOLOR="#000000"><TD colspan=6 align=center><font color=white><B><?php echo $this->_vars['l_autoroute_title']; ?></B></font></TD></TR>
		<TR BGCOLOR="#000000">
		<TD align='center'><B><font size=2 color='#79f487'><?php echo $this->_vars['l_nav_created']; ?></font></B></TD>
...
<?php extract($this->_vars, EXTR_REFS);  
		for($i = 0; $i < $autocount; $i++){
			...
			echo "<TD align='center'><font color='white'><b>$creationdate[$i]</b></font><br>";
			...
			echo "<TD align='center'><font size=2 color=yellow>$autoend[$i]</font></TD>\n";
 ...
 ?>
	<?php else: ?>
		<tr BGCOLOR="#3A3B6E"><TD colspan="6" align='center'><B><font size=2 color='#79f487'><br><?php echo $this->_vars['l_autoroute_noroutes']; ?></font></b><br><br>
		</td></tr>
	<?php endif; ?>
		<TR BGCOLOR="#000000">
		<TD colspan=6 align=center><font color=white size=2><B><?php echo $this->_vars['l_autoroute_info']; ?></B></font></td></tr>
		<TR BGCOLOR="#000000">
		</TABLE><BR><BR>
	</td></tr>
