...
<td align="center"><?php echo $this->_vars['l_g3d_wait']; ?></td></tr>
<tr><td align="center">
<img src="galaxy_map3dimage.php?shipsector=<?php echo $this->_vars['shipsector']; ?>&arm=<?php echo $this->_vars['arm']; ?>&distance=<?php echo $this->_vars['distance']; ?>&galaxy_id=<?php echo $this->_vars['galaxy_id']; ?>" border="0" alt="<?php echo $this->_vars['l_g3d_wait']; ?>">
</td></tr>
<tr><td align="center"><br>
<form action="galaxy_map3d.php" method="post" enctype="multipart/form-data">
<select name="arm">
<?php echo $this->_vars['armdropdown']; ?>
</select><br><br>
