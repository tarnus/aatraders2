...
<tr><td colspan=2 align=center valign=top><font size=2 face="courier new" color=#52ACEA><?php echo $this->_vars['l_igb_withdrawfunds']; ?><br>---------------------------------</td></tr>
<tr valign=top>
...
<tr valign=top>
<td><font size=2 face="courier new" color=#52ACEA><?php echo $this->_vars['l_igb_selwithdrawamount']; ?> :</td><td align=right>
<form action=igb.php?command=withdraw2 method=POST>
<input class=term type=text size=15 maxlength=20 name=amount value=0>
<br><br><input class=term type=submit value=<?php echo $this->_vars['l_igb_withdraw']; ?>>
</form></td></tr>
<tr valign=bottom>
