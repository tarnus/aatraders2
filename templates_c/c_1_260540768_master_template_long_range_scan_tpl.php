...
if (count((array)$this->_vars['lr_sector'])): foreach ((array)$this->_vars['lr_sector'] as $this->_vars['key'] => $this->_vars['item']): $this->_foreach['foreach1']['iteration']++;
 ?>
		<TR BGCOLOR="<?php echo $this->_vars['color']; ?>">
			<?php if ($this->_vars['lr_returnlink'][$this->_vars['key']] == 0): ?>
				<TD class="nav_title_12" align="center"><A class="mnu" HREF="main.php?move_method=warp&destination=<?php echo $this->_run_modifier($this->_vars['lr_sector'][$this->_vars['key']], 'urlencode', 'PHP', 1); ?>"><?php echo $this->_vars['lr_zonetype'][$this->_vars['key']];  echo $this->_vars['lr_sector'][$this->_vars['key']]; ?></A></TD>
			<?php else: ?>
				<TD class="nav_title_12" align="center"><A class="mnu2" HREF="main.php?move_method=warp&destination=<?php echo $this->_run_modifier($this->_vars['lr_sector'][$this->_vars['key']], 'urlencode', 'PHP', 1); ?>"><?php echo $this->_vars['lr_zonetype'][$this->_vars['key']];  echo $this->_vars['lr_sector'][$this->_vars['key']]; ?></A></TD>
			<?php endif; ?>
