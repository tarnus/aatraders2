				...
				<div align="center">
				  <table border="0" cellspacing="1" width="100%" bordercolorlight="black" bordercolordark="silver">
					<tr>
					  ...
					  <td width="4%" align="center" ><A HREF="main.php"><img alt="<?php echo $this->_vars['l_readm_return']; ?>" src="templates/master_template/images/c95x.png" width="16" height="14" border="0"></a></td>
					</tr>
				  </table>
				</div>
			  </td>
...
<?php endif; ?>
			...
			echo "		  <td width=\"4%\" height=\"19\" align=\"center\" bordercolorlight=\"black\" bordercolordark=\"black\"><A class=\"but\" HREF=\"message_read.php?action=delete&ID=$msgid[$i]\"><img src=\"templates/master_template/images/c95x.png\" width=\"16\" height=\"14\" border=\"0\"></a></td>";
			echo "		</tr>";
			echo "	  </table>";
			echo "	</div>";
			echo "  </td>";
