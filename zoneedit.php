...
$template_object->display("master_template/zoneedit.tpl");
...
function zoneedit_change()
{
	...
	if ($result>0)
	{
		while (!$result->EOF)
		{
			...
			{ 
				...
				$template_object->assign("l_ze_return", $l_ze_return);
				$template_object->assign("gotomain", $l_global_mmenu);
				$template_object->display("master_template/zoneeditsamename.tpl");
				include ("footer.php");
				die();
			}
			$result->MoveNext();
	...
	$template_object->assign("l_ze_return", $l_ze_return);
	$template_object->assign("gotomain", $l_global_mmenu);
	$template_object->display("master_template/zoneeditchange.tpl");
...
function zoneedit_die($error_msg)
{
	...
	$template_object->assign("gotomain", $l_global_mmenu);
	$template_object->display("master_template/zoneeditdie.tpl");
