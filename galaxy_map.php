...
$result = $db->Execute ("SELECT sector_name, spiral_arm, sector_id, port_type, x, y, z, zone_id FROM {$db_prefix}universe where galaxy_id=" . $shipinfo['galaxy_id'] . " and sector_id >= $startsector and sector_id <= $endsector and sg_sector = 0 ORDER BY sector_id ASC");
...
$template_object->display("master_template/galaxy_map.tpl");
include ("footer.php");
