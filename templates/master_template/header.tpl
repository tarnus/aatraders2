...
<html>
 <head>
  ...
  {literal}
          <script type="text/javascript" src="/backends/js/jquery-1.5.min.js"></script>
         <script type="text/javascript" src="/backends/js/jquery.jatt.min.js"></script>
        <script type="text/javascript" src="/backends/js/jquery.innerfade.js"></script>
...
{if $no_body != 1}
<body marginheight=0 marginwidth=0 topmargin=0 leftmargin=0 background="templates/default_menu/images/bgoutspace1.gif" bgcolor="#000000" text="#c0c0c0" link="#52ACEA" vlink="#52ACEA" alink="#52ACEA">
{$banner_top}
