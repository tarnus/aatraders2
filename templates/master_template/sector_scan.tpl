									...
									{foreach key=key value=item from=$planetid}
										<td align="center" valign="top" style="text-align:center;margin:0 auto;">
											{if $planetbounty[$key] > 0}
												<font color='red' size='4'><p align="center"><b>{$l_by_bountyscan}</b></p></font></br>
											{/if}
											<A HREF="planet.php?planet_id={$planetid[$key]}">
											{insert name="img" src="templates/master_template/images/planet`$planetimg[$key]`.png" alt="" width="100" height="100"}
...
<input type="Hidden" name="port_name" value="{$icon_alt_text}">
<input type="Hidden" name="port" value="{$icon_alt_text}">
			...
			<TR BGCOLOR="{$color_header}" VALIGN="top">
				...
				<TR BGCOLOR="{$color_header}" VALIGN="top">
					...
					<td>&nbsp;</td>
					<TD ALIGN="left"><font size="2"><input type="Text" name="port" width="10" value="{if $port_type == "wormhole"}{$icon_alt_text}{else}{$port_type}{/if}">&nbsp;</font></TD>
				</tr>
				<TR BGCOLOR="{$color_header}" VALIGN="top">
