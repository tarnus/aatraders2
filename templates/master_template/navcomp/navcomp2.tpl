...
<table width="90%" border="1" cellspacing="0" cellpadding="4" align="center">
  <tr>
    <td bgcolor="#000000" valign="top" align="center" colspan=2>
		...
		<TR BGCOLOR="#000000"><TD colspan=6 align=center><font color=white><B>{$l_autoroute_title}</B></font></TD></TR>
		<TR BGCOLOR="#000000">
		<TD align='center'><B><font size=2 color='#79f487'>{$l_nav_created}</font></B></TD>
...
{/php}
	{else}
		<tr BGCOLOR="#3A3B6E"><TD colspan="6" align='center'><B><font size=2 color='#79f487'><br>{$l_autoroute_noroutes}</font></b><br><br>
		</td></tr>
	{/if}
		<TR BGCOLOR="#000000">
		<TD colspan=6 align=center><font color=white size=2><B>{$l_autoroute_info}</B></font></td></tr>
		<TR BGCOLOR="#000000">
		</TABLE><BR><BR>
	</td></tr>
