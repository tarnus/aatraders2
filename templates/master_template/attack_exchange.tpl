  ...
  <tr>
    <td class="header"><h3>{$target_title}</br>
    	{if $attacktype == "planet"}
			{insert name="img" src="templates/master_template/images/planet`$titleimage`.png" alt="" width="100" height="100"}
   		{else}
			<img src="templates/master_template/images/{$titleimage}.gif" border=0>
		{/if}
		{if $isfedbounty == 0}
	  		</br></br><b>{$l_by_nofedbounty}</b>
		{else}
			</br></br><b><span class="red">{$l_by_fedbounty2}</span></b>
		{/if}
		</h3>
	</td>
  </tr>
