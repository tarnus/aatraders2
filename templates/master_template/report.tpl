  ...
  <tr>
	...
	<table border=0 cellspacing=0 cellpadding=3>
	  <tr>
		<td>
		<font size=2><b>
		&nbsp;<img src=templates/master_template/images/credits.png>&nbsp;{$l_credits}&nbsp;&nbsp;&nbsp;
		</b></font>
		<td>
		<font color=white><b>
...
{/if}
	...
	<table border=0 cellspacing=0 cellpadding=3>
	  ...
	  <tr>
		<td>
		<font size=2><b>
		&nbsp;<img src=templates/master_template/images/energy.png>&nbsp;{$l_energy}&nbsp;&nbsp;&nbsp;
		</b></font>
		<td>
		<font color=white><b>
	  ...
	  <tr>
		<td>
		<font size=2><b>
		&nbsp;<img src=templates/master_template/images/tfighter.png>&nbsp;<a href=defense_deploy.php>{$l_fighters}</a>&nbsp;&nbsp;&nbsp;
		</b></font>
		<td>
		<font color=white><b>
	  ...
	  <tr>
		<td>
		<font size=2><b>
		&nbsp;<img src=templates/master_template/images/torp.png>&nbsp;<a href=defense_deploy.php>{$l_torps}</a>&nbsp;&nbsp;&nbsp;
		</b></font>
		<td>
		<font color=white><b>
	  ...
	  <tr>
		<td>
		<font size=2><b>
		&nbsp;<img src=templates/master_template/images/armor.png>&nbsp;{$l_armorpts}&nbsp;&nbsp;&nbsp;
		</b></font>
		<td>
		<font color=white><b>
