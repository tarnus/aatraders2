...
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
  ...
  <tr>
    <td class="leftColumnMini" nowrap colspan="2"><b>{$l_cmb_target_mines}</b></br>{$start_target_mines}</td>
  </tr>
</table>
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
...
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
  ...
  <tr>
    <td class="leftColumnMini" nowrap colspan="2"><b>{$l_cmb_target_mines}</b></br>{$end_target_mines}</td>
  </tr>
</table>
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
