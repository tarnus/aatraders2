...
{$l_ship_perform}<br><br>
	...
	<tr>
		<td><font color=white><a href=scan.php?ship_id={$ship_id}>{$l_planet_scn_link}</a></font><br><br></td>
	</tr>
	<tr>
		<td><a href=attack.php?ship_id={$ship_id}>{$l_planet_att_link}</a><br><br></td>
	</tr>
<tr>
