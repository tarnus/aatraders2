...
{if $totalpages > 1}
	...
	<TR>
		<td align="left" width="33%">
			{if $currentpage != 1}
				<a href="planet_report.php?commandpage=production_view&page={$previouspage}&sort={$sort}">{$l_rpt_prev}</a>
			{else}
				&nbsp;
			{/if}
		</td>
	...
	&nbsp;<input type="submit" value="{$l_submit}">
		...
		<td align="right" width="33%">
			{if $currentpage != $totalpages}
				<a href="planet_report.php?commandpage=production_view&page={$nextpage}&sort={$sort}">{$l_rpt_next}</a>
			{else}
				&nbsp;
			{/if}
		</td>
...
{/if}
	...
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=sector_id>{$l_pr_sector}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=galaxy_id>{$l_galaxy}</A></B></font></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=name>{$l_name}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=ore>{$l_ore}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=organics>{$l_organics}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=goods>{$l_goods}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=energy>{$l_energy}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=special>{$l_pr_special}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=colonists>{$l_colonists}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=credits>{$l_credits}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=fighters>{$l_fighters}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=torp>{$l_torps}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=research>{$l_pr_research}</A></B></TD>
	<TD ALIGN=CENTER><B><A HREF=planet_report.php?commandpage=production_view&sort=build>{$l_pr_build}</A></B></TD>
	{if $playerteam > 0}
	...
	<TD COLSPAN=3 ALIGN=CENTER>{$l_pr_totals}</TD>
	<TD></TD>
	<TD></TD>
	<TD></TD>
	<TD></TD>
	<TD></TD>
	<TD ALIGN=CENTER>{$total_colonists}</TD>
	<TD ALIGN=CENTER>{$total_credits}</TD>
	<TD></TD>
	<TD></TD>
	{if $playerteam > 0}
		<TD></TD>
