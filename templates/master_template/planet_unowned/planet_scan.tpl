...
<table border=0 cellspacing=0 cellpadding=0 width=90% align="center">
  <tr>
		<td align="center" valign=top>
			{insert name="img" src="templates/master_template/images/planet`$planettype`.png" alt="" width="100" height="100" border="1"}
		</td></tr><tr>
	<td align="center">
	{if $sc_base != "N"}
  ...
  <tr>
	...
	<table border=0 cellspacing=0 cellpadding=3 >
	  <tr>
		<td>
		<font size=2><b>
		&nbsp;{insert name="img" src="templates/master_template/images/credits.png" alt="" width="12" height="12" border="0"}&nbsp;{$l_credits}&nbsp;&nbsp;&nbsp;
		</b></font>
		<td>
		<font color=white><b>
		{$planetinfo_credits}
...
{/if}
	...
	<table border=0 cellspacing=0 cellpadding=3>
	  ...
	  <tr>
		<td>
		<font size=2><b>
		&nbsp;{insert name="img" src="templates/master_template/images/tfighter.png" alt="" width="12" height="12" border="0"}&nbsp;{$l_fighters}&nbsp;&nbsp;&nbsp;
		</b></font>
		<td>
		<font color=white><b>
		{$planetinfo_fighters}
	  ...
	  <tr>
		<td>
		<font size=2><b>
		&nbsp;{insert name="img" src="templates/master_template/images/torp.png" alt="" width="12" height="12" border="0"}&nbsp;{$l_torps}&nbsp;&nbsp;&nbsp;
		</b></font>
		<td>
		<font color=white><b>
		{$planetinfo_torps}
	  ...
	  <tr>
		<td>
		<font size=2><b>
		&nbsp;{insert name="img" src="templates/master_template/images/armor.png" alt="" width="12" height="12" border="0"}&nbsp;{$l_armorpts}&nbsp;&nbsp;&nbsp;
		</b></font>
		<td>
		<font color=white><b>
