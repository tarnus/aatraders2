...
<tr><td>{if $planetowner != 3}
		...
		{if $enable_spies == 1}
			{if $numspies != 0}
				...
				<TR BGCOLOR="#000000"><TD>&nbsp;</TD><TD align="center"><B>{$l_ore}</B></TD><TD align="center"><B>{$l_organics}</B></TD><TD align="center"><B>{$l_goods}</B></TD><TD align="center"><B>{$l_specialname}</B></TD><TD align="center"><B>{$l_energy}</B></TD><TD align="center"><B>{$l_colonists}</B></TD><TD align="center"><B>{$l_credits}</B></TD><TD align="center"><B>{$l_fighters}</B></TD><TD align="center"><B>{$l_torps}</B></TD>
				...
				<TD align="center"><INPUT TYPE=TEXT VALUE="{$planetspecial}" SIZE=14 ></TD>
				...
				<TD align="center"><INPUT TYPE=TEXT VALUE="{$prodspecial}" SIZE=3 MAXLENGTH=3 ></TD>
