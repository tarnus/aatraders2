...
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td class="header"><h3>{$l_planet_combatpreview}</br>
		{insert name="img" src="templates/master_template/images/planet`$titleimage`.png" alt="" width="100" height="100"}<br>
		{$planetname}</h3>
	</td>
  </tr>
	{if $isfedbounty == 0}
	...
	{else}
		<tr><td colspan="3" align="center" class="portfooter"><b><span class="red">{$l_by_fedbounty}</span></b></td></tr>
	{/if}
</table>
<table width="600" border="1" align="center" cellpadding="5" cellspacing="0">
  <tr>
