...
<a href="news.php?startdate={$previousday}">{$l_news_prev|ucfirst}</a><img src="templates/master_template/images_fnn/spacer.gif" width="160" height="1" alt="1" />{$l_news_for} {$today}<img src="templates/master_template/images_fnn/spacer.gif" width="160" height="1" alt="1" /><a href="news.php?startdate={$nextday}">{$l_news_next|ucfirst}</a>
</td>
</tr>
