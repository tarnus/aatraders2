...
var target_sector = '' ;
var returndata = '' ;
var returnmessage = "{/literal}{$l_mininavinfo}{literal}";
var elementlist;
...
function makeRequest()
{
	...
	xmlDoc.open( "GET", "{/literal}{$full_url}{literal}ajax_processor.php?command=mininav_autoroute_find&endsector=" + target_sector, false );
	xmlDoc.send( null );
...
function process() {
	...
	{
		ddrivetip("{/literal}{$l_noroutetosectortitle}{literal}","{/literal}{$l_noroutetosectorbody}{literal}");
...
//	returnmessage = '<br><br>{/literal}{$l_autoroutelist}{literal}<br>';
...
//	returnmessage = returnmessage + elementlist[1] + '<br><br>'
	document.location.href = '{/literal}{$full_url}{literal}navcomp.php?state=immediatestart&destination=' + elementlist[1] + "&forward_warp_list=" + elementlist[0];
}
...
{/if}
{literal}
key['p'] = "planet_report.php?commandpage=commodities"; 
key['r'] = "ranking.php"; 
key['R'] = "report.php"; 
...
<script type="text/javascript" src="templates/windowed_menu/wz_dragd.js"></script>
...
.suckertreemenu .mainfoldericon{
	background: #4455aa url(templates/windowed_menu/images/arrow_down.gif) no-repeat center right;
}

/*Background image for subsequent level menu list links */
.suckertreemenu .subfoldericon{
	background: #4455aa url(templates/windowed_menu/images/arrow_right.gif) no-repeat center right;
}
...
{if $galaxy_map_enabled == true and $gd_enabled == true}
...
{/if}
	...
	<li><a href="#">{$l_help}</a>
		<ul>
			<li><a href="#">{$l_help_title} #1</a>
				<ul>
					<li><a href="#">{$l_help_subtitle}</a></li>
					<li><a href="#"></a></li>
					<li><a href="#">a = {$l_help_addtraderoute}</a></li>
					<li><a href="#">b = {$l_help_globalchat}</a></li>
					<li><a href="#">B = {$l_help_beacon}</a></li>
					<li><a href="#">c = {$l_help_genesisdevice}</a></li>
					<li><a href="#">C = {$l_help_sectorgenesis}</a></li>
					<li><a href="#">D = {$l_help_devicemenu}</a></li>
					<li><a href="#">d = {$l_help_SDreport}</a></li>
					<li><a href="#">e = {$l_help_Ewarp}</a></li>
					<li><a href="#">f = {$l_help_fullLRscan}</a></li>
					<li><a href="#">g = {$l_help_galaxymap}</a></li>
					<li><a href="#">G = {$l_help_localmap}</a></li>
				</ul>
			</li>
			<li><a href="#">{$l_help_title} #2</a>
				<ul>
					<li><a href="#">{$l_help_subtitle}</a></li>
					<li><a href="#"></a></li>
					<li><a href="#">i = {$l_help_IGB}</a></li>
					<li><a href="#">l = {$l_help_log}</a></li>
					<li><a href="#">L = {$l_help_logout}</a></li>
					<li><a href="#">m = {$l_help_readmessages}</a></li>
					<li><a href="#">M = {$l_help_deploymines}</a></li>
					<li><a href="#">n = {$l_help_news}</a></li>
					<li><a href="#">N = {$l_help_sectornotes}</a></li>
					<li><a href="#">o = {$l_help_options}</a></li>
					<li><a href="#">p = {$l_help_planetreport}</a></li>
					<li><a href="#">P = {$l_help_probemenu}</a></li>
					<li><a href="#">r = {$l_help_ranking}</a></li>
				</ul>
			</li>
			<li><a href="#">{$l_help_title} #3</a>
				<ul>
					<li><a href="#">{$l_help_subtitle}</a></li>
					<li><a href="#"></a></li>
					<li><a href="#">R = {$l_help_shipreport}</a></li>
					<li><a href="#">s = {$l_help_sendmessage}</a></li>
					<li><a href="#">t = {$l_help_listTRroutes}</a></li>
					<li><a href="#">T = {$l_help_teamSD}</a></li>
					<li><a href="#">u = {$l_help_3Dmap}</a></li>
					<li><a href="#">w = {$l_help_warpeditor}</a></li>
					<li><a href="#">z = {$l_help_storeshipreport}</a></li>
					<li><a href="#">[ = {$l_help_dignitarymenu}</a></li>
					<li><a href="#">] = {$l_help_spymenu}</a></li>
					<li><a href="#">. = {$l_help_galaxylocalwindow}</a></li>
				</ul>
			</li>
...
<TR align="center"><TD><img src="images/avatars/{$avatar}"></td></tr>
		{/if}
<tr><td class=normal>{$l_rank}: <img src="templates/windowed_menu/images/rank/{$insignia}"></td></tr>
...
<img name="resizehandle_player" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_player" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_energy}" src="templates/windowed_menu/images/energy.png">&nbsp;{$l_energy}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_fighters}" src="templates/windowed_menu/images/tfighter.png">&nbsp;{$l_fighters}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
{if $shipinfo_torps != "0"}
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_torps}" src="templates/windowed_menu/images/torp.png">&nbsp;{$l_torps}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
{if $shipinfo_armor != "0"}
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_armorpts}" src="templates/windowed_menu/images/armor.png">&nbsp;{$l_armor}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_credits}" src="templates/windowed_menu/images/credits.png">&nbsp;{$l_credits}</td><td width="50%" nowrap align='right' colspan=2><span class=mnu>&nbsp;
{php}
...
<img name="resizehandle_cargo" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_cargo" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
...
<tr>
	<td bgcolor="#000000" background="templates/master_template/images/spacer.gif" width="100%" ID="IEshout" align="center" valign="top">
<layer id="shout"</layer>
	</td>
</tr>
</table>
	</div>
<img name="resizehandle_shoutbox" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_shoutbox" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
{/if}
...
<table cellspacing = "0" cellpadding = "0" border = "0" align="center">
<tr>
	<TD valign="top" align="center" bgcolor="#000000" bgcolor="templates/master_template/images/spacer.gif" width="100%" ID="IEnews">
<layer id="news"</layer>
	</td>
</tr>
</table>
	</div>
<img name="resizehandle_news" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_news" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
{/if}
...
<img name="resizehandle_traderoutes" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_traderoutes" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
...
<table cellpadding="0" align="left" cellspacing="0">
	...
	<input type="Text" name="sbt"  class="shoutform" size="14" maxlength="250" ONBLUR="document.onkeypress = getKey;" ONFOCUS="document.onkeypress = null;"><input type="submit" name="go" value="Go" class="shoutform"><br>{$l_public}&nbsp;
...
<img name="resizehandle_shoutboxinput" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_shoutboxinput" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
...
<img name="resizehandle_warplinks" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_warplinks" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
...
<select name="menu" onChange="location=document.lastsector.menu.options[document.lastsector.menu.selectedIndex].value;" value="GO" class="rsform"><option value="">{$l_RStolastsector}</option>
...
<img name="resizehandle_realspace" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_realspace" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
...
<tr>
{if $xyminusp[8] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx3[8]);{/php}
		<TD bgcolor={$sectorzonecolorx3[8]}><A HREF="javascript:fillrealspace('{$altsectorx3[8]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminusp[8]} - {$altportx3[8]}<br>{$altturnsx3[8]}','{$l_galacticarm}: {$galacticarmx3[8]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx3[8]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[8]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex3[8]}.png" title="{$sectortitlex3[8]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}
{if $xyminusp[6] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx3[6]);{/php}
		<TD bgcolor={$sectorzonecolorx3[6]}><A HREF="javascript:fillrealspace('{$altsectorx3[6]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminusp[6]} - {$altportx3[6]}<br>{$altturnsx3[6]}','{$l_galacticarm}: {$galacticarmx3[6]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx3[6]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[6]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex3[6]}.png" title="{$sectortitlex3[6]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}
{if $xyminusp[4] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx3[4]);{/php}
		<TD bgcolor={$sectorzonecolorx3[4]}><A HREF="javascript:fillrealspace('{$altsectorx3[4]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminusp[4]} - {$altportx3[4]}<br>{$altturnsx3[4]}','{$l_galacticarm}: {$galacticarmx3[4]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx3[4]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[4]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex3[4]}.png" title="{$sectortitlex3[4]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
	<TD bgcolor=black rowspan="3" valign="bottom"><img src="templates/windowed_menu/images/nav_vert.gif"  border=0 width = "12" height = "36"></td>
{if $xyplus[4] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx1[4]);{/php}
		<TD bgcolor={$sectorzonecolorx1[4]}><A HREF="javascript:fillrealspace('{$altsectorx1[4]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplus[4]} - {$altportx1[4]}<br>{$altturnsx1[4]}','{$l_galacticarm}: {$galacticarmx1[4]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx1[4]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[4]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex1[4]}.png" title="{$sectortitlex1[4]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}
{if $xyplus[6] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx1[6]);{/php}
		<TD bgcolor={$sectorzonecolorx1[6]}><A HREF="javascript:fillrealspace('{$altsectorx1[6]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplus[6]} - {$altportx1[6]}<br>{$altturnsx1[6]}','{$l_galacticarm}: {$galacticarmx1[6]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx1[6]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[6]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex1[6]}.png" title="{$sectortitlex1[6]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
{if $xyplus[8] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx1[8]);{/php}
		<TD bgcolor={$sectorzonecolorx1[8]}><A HREF="javascript:fillrealspace('{$altsectorx1[8]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplus[8]} - {$altportx1[8]}<br>{$altturnsx1[8]}','{$l_galacticarm}: {$galacticarmx1[8]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx1[8]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[8]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex1[8]}.png" title="{$sectortitlex1[8]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
</tr>
<tr>
{if $xyminusp[7] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx3[7]);{/php}
		<TD bgcolor={$sectorzonecolorx3[7]}><A HREF="javascript:fillrealspace('{$altsectorx3[7]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminusp[7]} - {$altportx3[7]}<br>{$altturnsx3[7]}','{$l_galacticarm}: {$galacticarmx3[7]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx3[7]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[7]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex3[7]}.png" title="{$sectortitlex3[7]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}
{if $xyminusp[3] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx3[3]);{/php}
		<TD bgcolor={$sectorzonecolorx3[3]}><A HREF="javascript:fillrealspace('{$altsectorx3[3]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminusp[3]} - {$altportx3[3]}<br>{$altturnsx3[3]}','{$l_galacticarm}: {$galacticarmx3[3]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx3[3]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[3]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex3[3]}.png" title="{$sectortitlex3[3]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
{if $xyminusp[1] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx3[1]);{/php}
		<TD bgcolor={$sectorzonecolorx3[1]}><A HREF="javascript:fillrealspace('{$altsectorx3[1]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminusp[1]} - {$altportx3[1]}<br>{$altturnsx3[1]}','{$l_galacticarm}: {$galacticarmx3[1]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx3[1]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[1]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex3[1]}.png" title="{$sectortitlex3[1]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	

{if $xyplus[1] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx1[1]);{/php}
		<TD bgcolor={$sectorzonecolorx1[1]}><A HREF="javascript:fillrealspace('{$altsectorx1[1]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplus[1]} - {$altportx1[1]}<br>{$altturnsx1[1]}','{$l_galacticarm}: {$galacticarmx1[1]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx1[1]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[1]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex1[1]}.png" title="{$sectortitlex1[1]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
{if $xyplus[3] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx1[3]);{/php}
		<TD bgcolor={$sectorzonecolorx1[3]}><A HREF="javascript:fillrealspace('{$altsectorx1[3]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplus[3]} - {$altportx1[3]}<br>{$altturnsx1[3]}','{$l_galacticarm}: {$galacticarmx1[3]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx1[3]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[3]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex1[3]}.png" title="{$sectortitlex1[3]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}			
{if $xyplus[7] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx1[7]);{/php}
		<TD bgcolor={$sectorzonecolorx1[7]}><A HREF="javascript:fillrealspace('{$altsectorx1[7]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplus[7]} - {$altportx1[7]}<br>{$altturnsx1[7]}','{$l_galacticarm}: {$galacticarmx1[7]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx1[7]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[7]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex1[7]}.png" title="{$sectortitlex1[7]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}			
</tr>
<tr>
{if $xyminusp[5] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx3[5]);{/php}
		<TD bgcolor={$sectorzonecolorx3[5]}><A HREF="javascript:fillrealspace('{$altsectorx3[5]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminusp[5]} - {$altportx3[5]}<br>{$altturnsx3[5]}','{$l_galacticarm}: {$galacticarmx3[5]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx3[5]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[5]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex3[5]}.png" title="{$sectortitlex3[5]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}
{if $xyminusp[2] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx3[2]);{/php}
		<TD bgcolor={$sectorzonecolorx3[2]}><A HREF="javascript:fillrealspace('{$altsectorx3[2]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminusp[2]} - {$altportx3[2]}<br>{$altturnsx3[2]}','{$l_galacticarm}: {$galacticarmx3[2]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx3[2]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[2]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex3[2]}.png" title="{$sectortitlex3[2]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
{if $xyminusp[0] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx3[0]);{/php}
		<TD bgcolor={$sectorzonecolorx3[0]}><A HREF="javascript:fillrealspace('{$altsectorx3[0]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminusp[0]} - {$altportx3[0]}<br>{$altturnsx3[0]}','{$l_galacticarm}: {$galacticarmx3[0]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx3[0]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx3[0]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex3[0]}.png" title="{$sectortitlex3[0]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	

{if $xyplus[0] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx1[0]);{/php}
		<TD bgcolor={$sectorzonecolorx1[0]}><A HREF="javascript:fillrealspace('{$altsectorx1[0]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplus[0]} - {$altportx1[0]}<br>{$altturnsx1[0]}','{$l_galacticarm}: {$galacticarmx1[0]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx1[0]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[0]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex1[0]}.png" title="{$sectortitlex1[0]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
{if $xyplus[2] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx1[2]);{/php}
		<TD bgcolor={$sectorzonecolorx1[2]}><A HREF="javascript:fillrealspace('{$altsectorx1[2]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplus[2]} - {$altportx1[2]}<br>{$altturnsx1[2]}','{$l_galacticarm}: {$galacticarmx1[2]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx1[2]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[2]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex1[2]}.png" title="{$sectortitlex1[2]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
{if $xyplus[5] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx1[5]);{/php}
		<TD bgcolor={$sectorzonecolorx1[5]}><A HREF="javascript:fillrealspace('{$altsectorx1[5]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplus[5]} - {$altportx1[5]}<br>{$altturnsx1[5]}','{$l_galacticarm}: {$galacticarmx1[5]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx1[5]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx1[5]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex1[5]}.png" title="{$sectortitlex1[5]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
</tr>
<tr bgcolor=black><td colspan="3" valign="middle" align="right"><img src="templates/windowed_menu/images/nav_horz.gif"  border=0 width = "48" height = "12"></td><td border=1 valign="middle" align="center"><A HREF="#" onMouseover="ddrivetip('{$l_sector}: {$sector}','{$l_galacticarm}: {$ship_galacticarm}<br><br>{php} $coords = explode("|", $ship_coordinates); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]"{/php}');" onMouseout="hideddrivetip()"><img src="images/ports/yourhere.gif" border="0"></a></td><td colspan="3" align="left" valign="middle"><img src="templates/windowed_menu/images/nav_horz.gif"  border=0 width = "48" height = "12"></td></tr>
<tr>
{if $xyminus[4] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx2[4]);{/php}
		<TD bgcolor={$sectorzonecolorx2[4]}><A HREF="javascript:fillrealspace('{$altsectorx2[4]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminus[4]} - {$altportx2[4]}<br>{$altturnsx2[4]}','{$l_galacticarm}: {$galacticarmx2[4]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx2[4]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[4]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex2[4]}.png" title="{$sectortitlex2[4]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
{if $xyminus[2] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx2[2]);{/php}
		<TD bgcolor={$sectorzonecolorx2[2]}><A HREF="javascript:fillrealspace('{$altsectorx2[2]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminus[2]} - {$altportx2[2]}<br>{$altturnsx2[2]}','{$l_galacticarm}: {$galacticarmx2[2]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx2[2]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[2]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex2[2]}.png" title="{$sectortitlex2[2]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}
{if $xyminus[0] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx2[0]);{/php}
		<TD bgcolor={$sectorzonecolorx2[0]}><A HREF="javascript:fillrealspace('{$altsectorx2[0]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminus[0]} - {$altportx2[0]}<br>{$altturnsx2[0]}','{$l_galacticarm}: {$galacticarmx2[0]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx2[0]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[0]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex2[0]}.png" title="{$sectortitlex2[0]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
	<TD bgcolor=black rowspan="3" valign="top"><img src="templates/windowed_menu/images/nav_vert.gif"  border=0 width = "12" height = "36"></td>
{if $xyplusm[0] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx4[0]);{/php}
		<TD bgcolor={$sectorzonecolorx4[0]}><A HREF="javascript:fillrealspace('{$altsectorx4[0]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplusm[0]} - {$altportx4[0]}<br>{$altturnsx4[0]}','{$l_galacticarm}: {$galacticarmx4[0]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx4[0]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[0]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex4[0]}.png" title="{$sectortitlex4[0]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
{if $xyplusm[2] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx4[2]);{/php}
		<TD bgcolor={$sectorzonecolorx4[2]}><A HREF="javascript:fillrealspace('{$altsectorx4[2]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplusm[2]} - {$altportx4[2]}<br>{$altturnsx4[2]}','{$l_galacticarm}: {$galacticarmx4[2]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx4[2]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[2]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex4[2]}.png" title="{$sectortitlex4[2]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
{if $xyplusm[4] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx4[4]);{/php}
		<TD bgcolor={$sectorzonecolorx4[4]}><A HREF="javascript:fillrealspace('{$altsectorx4[4]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplusm[4]} - {$altportx4[4]}<br>{$altturnsx4[4]}','{$l_galacticarm}: {$galacticarmx4[4]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx4[4]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[4]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex4[4]}.png" title="{$sectortitlex4[4]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
</tr>
<tr>
{if $xyminus[6] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx2[6]);{/php}
		<TD bgcolor={$sectorzonecolorx2[6]}><A HREF="javascript:fillrealspace('{$altsectorx2[6]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminus[6]} - {$altportx2[6]}<br>{$altturnsx2[6]}','{$l_galacticarm}: {$galacticarmx2[6]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx2[6]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[6]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex2[6]}.png" title="{$sectortitlex2[6]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
{if $xyminus[1] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx2[1]);{/php}
		<TD bgcolor={$sectorzonecolorx2[1]}><A HREF="javascript:fillrealspace('{$altsectorx2[1]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminus[1]} - {$altportx2[1]}<br>{$altturnsx2[1]}','{$l_galacticarm}: {$galacticarmx2[1]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx2[1]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[1]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex2[1]}.png" title="{$sectortitlex2[1]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	

{if $xyminus[3] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx2[3]);{/php}
		<TD bgcolor={$sectorzonecolorx2[3]}><A HREF="javascript:fillrealspace('{$altsectorx2[3]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminus[3]} - {$altportx2[3]}<br>{$altturnsx2[3]}','{$l_galacticarm}: {$galacticarmx2[3]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx2[3]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[3]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex2[3]}.png" title="{$sectortitlex2[3]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		

{if $xyplusm[3] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx4[3]);{/php}
		<TD bgcolor={$sectorzonecolorx4[3]}><A HREF="javascript:fillrealspace('{$altsectorx4[3]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplusm[3]} - {$altportx4[3]}<br>{$altturnsx4[3]}','{$l_galacticarm}: {$galacticarmx4[3]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx4[3]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[3]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex4[3]}.png" title="{$sectortitlex4[3]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
{if $xyplusm[1] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx4[1]);{/php}
		<TD bgcolor={$sectorzonecolorx4[1]}><A HREF="javascript:fillrealspace('{$altsectorx4[1]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplusm[1]} - {$altportx4[1]}<br>{$altturnsx4[1]}','{$l_galacticarm}: {$galacticarmx4[1]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx4[1]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[1]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex4[1]}.png" title="{$sectortitlex4[1]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
{if $xyplusm[6] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx4[6]);{/php}
		<TD bgcolor={$sectorzonecolorx4[6]}><A HREF="javascript:fillrealspace('{$altsectorx4[6]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplusm[6]} - {$altportx4[6]}<br>{$altturnsx4[6]}','{$l_galacticarm}: {$galacticarmx4[6]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx4[6]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[6]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex4[6]}.png" title="{$sectortitlex4[6]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}				
</tr>
<tr>
{if $xyminus[8] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx2[8]);{/php}
		<TD bgcolor={$sectorzonecolorx2[8]}><A HREF="javascript:fillrealspace('{$altsectorx2[8]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminus[8]} - {$altportx2[8]}<br>{$altturnsx2[8]}','{$l_galacticarm}: {$galacticarmx2[8]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx2[8]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[8]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex2[8]}.png" title="{$sectortitlex2[8]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
{if $xyminus[7] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx2[7]);{/php}
		<TD bgcolor={$sectorzonecolorx2[7]}><A HREF="javascript:fillrealspace('{$altsectorx2[7]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminus[7]} - {$altportx2[7]}<br>{$altturnsx2[7]}','{$l_galacticarm}: {$galacticarmx2[7]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx2[7]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[7]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex2[7]}.png" title="{$sectortitlex2[7]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
{if $xyminus[5] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx2[5]);{/php}
		<TD bgcolor={$sectorzonecolorx2[5]}><A HREF="javascript:fillrealspace('{$altsectorx2[5]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyminus[5]} - {$altportx2[5]}<br>{$altturnsx2[5]}','{$l_galacticarm}: {$galacticarmx2[5]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx2[5]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx2[5]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex2[5]}.png" title="{$sectortitlex2[5]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	

{if $xyplusm[5] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx4[5]);{/php}
		<TD bgcolor={$sectorzonecolorx4[5]}><A HREF="javascript:fillrealspace('{$altsectorx4[5]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplusm[5]} - {$altportx4[5]}<br>{$altturnsx4[5]}','{$l_galacticarm}: {$galacticarmx4[5]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx4[5]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[5]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex4[5]}.png" title="{$sectortitlex4[5]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	

{if $xyplusm[7] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx4[7]);{/php}
		<TD bgcolor={$sectorzonecolorx4[7]}><A HREF="javascript:fillrealspace('{$altsectorx4[7]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplusm[7]} - {$altportx4[7]}<br>{$altturnsx4[7]}','{$l_galacticarm}: {$galacticarmx4[7]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx4[7]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[7]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex4[7]}.png" title="{$sectortitlex4[7]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
	
{if $xyplusm[8] != ""}
		{php}$warp_links = str_replace("|", ", ", $link_listx4[8]);{/php}
		<TD bgcolor={$sectorzonecolorx4[8]}><A HREF="javascript:fillrealspace('{$altsectorx4[8]}'); " onMouseover="ddrivetip('{$l_sector}: {$xyplusm[8]} - {$altportx4[8]}<br>{$altturnsx4[8]}','{$l_galacticarm}: {$galacticarmx4[8]}<br><br>{php} $coords = explode("|", $nav_scan_coordsx4[8]); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]<br><br>$l_port_buys<br>$buy_listx4[8]<br><br>$l_links:<br>$warp_links<hr>"{/php}' + returnmessage);" onMouseout="hideddrivetip()"><img src="images/ports/{$sectorimagex4[8]}.png" title="{$sectortitlex4[8]}" border=0 width = "12" height = "12"></A></TD>
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}				
...
<img name="resizehandle_mininav" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_mininav" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
...
<td align=center class=nav_title_12 width="33%"><b>{$galaxy_name}{if $beacon != ""}<br>{$beacon}{/if}</b></td>
      ...
      <table width="50%" border="0" cellspacing="3" cellpadding="3" align="{php} echo ($countplanet > 0) ? "right" : "center";{/php}">
        <tr> 
		  ...
		  {if $countplanet > 3}
			...
			{insert name="img" src="templates/windowed_menu/images/planet`$planetimg[3]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[3]}
...
{/if}</td>
        ...
        <tr> 
		  ...
		  {if $port_type != "none"}
		  <a href=port.php><img src="images/ports/port_{$port_type}.gif" border="0" alt="{$port_type} port" onMouseover="ddrivetip('{$portname}','{$port_description}');" onMouseout="hideddrivetip()"></a><br><br><b><font color=#33ff00>{$portname}</font></b></td>
          <td colspan="2" rowspan="3" align="center" valign="middle" class=nav_title_12>
	{/if}
		  {if $sector_location == 1}
		  <a href="casino.php?casinogame=casino_forums"><img src="images/ports/port_fedinfo.gif" border="0" alt="" onMouseover="ddrivetip('{$l_fedinfo}','{$l_infoport_description}');" onMouseout="hideddrivetip()"></a><br><br><b><font color=#33ff00>{$l_fedinfo}</font></b></td>
          <td colspan="2" rowspan="3" align="center" valign="middle" class=nav_title_12>
	{/if}
		</td>
        </tr>
        <tr> 
		  ...
		  {if $countplanet > 1}
			...
			{insert name="img" src="templates/windowed_menu/images/planet`$planetimg[1]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[1]}
        ...
        <tr> 
		  ...
		  {if $countplanet > 0}
			...
			{insert name="img" src="templates/windowed_menu/images/planet`$planetimg[0]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[0]}
        ...
        <tr> 
		  ...
		  {if $countplanet > 2}
			...
			{insert name="img" src="templates/windowed_menu/images/planet`$planetimg[2]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[2]}
		  ...
		  {if $countplanet > 4}
			...
			{insert name="img" src="templates/windowed_menu/images/planet`$planetimg[4]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[4]}
...
<img src="templates/windowed_menu/images/{$startypes}.gif" border="0" alt="" style="position: absolute; z-index:-1; left: 90%; top: 30%; margin-left: -240px; margin-top: -140px;">

	</div>
<img name="resizehandle_planet_display" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_planet_display" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
		...
		{if $playercount != 0}
			{for start=0 stop=$playercount-1 step=1 value=myLoop}
   				{if $shipprobe[$myLoop] == "ship"}
					...
					<img src="templates/windowed_menu/images/{$shipimage[$myLoop]}.gif" border=0></a><BR>
					{$shipnames[$myLoop]}
...
<img name="resizehandle_enemy_display" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_enemy_display" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
...
{php}
	...
	for($i = 0; $i < $defensecount; $i++){
		if($defensetype[$i] == "fighters"){
			if($count == 0){
				echo "<td align=center valign=top><img src=templates/windowed_menu/images/fighters.gif><br>";
			}
...
{php}
	...
	for($i = 0; $i < $defensecount; $i++){
		if($defensetype[$i] == "mines"){
			if($count == 0){
				echo "<td align=center valign=top><img src=templates/windowed_menu/images/mines.gif><br>";
			}
			echo " <font class=normal>";
			echo "<a class=mnu href=defense_modify.php?defense_id=" . $defenseid[$i] . "><b>";
			echo $defplayername[$i];
...
{/if}	</div>
<img name="resizehandle_sectordefense_display" src="templates/windowed_menu/images/winresiz.gif" width="4" height="4" alt="" style="visibility:hidden;">
<img name="resizebutton_sectordefense_display" src="templates/windowed_menu/images/button_up_outset.gif" width="12" height="10" alt="" style="visibility:hidden;">
...
button_down_outset.src = 'templates/windowed_menu/images/button_down_outset.gif';
button_down_inset.src = 'templates/windowed_menu/images/button_down_inset.gif';
button_up_outset.src = 'templates/windowed_menu/images/button_up_outset.gif';
button_up_inset.src = 'templates/windowed_menu/images/button_up_inset.gif';
