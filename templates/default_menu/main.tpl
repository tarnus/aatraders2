...
<tr bgcolor="#52ACEA">
    ...
    <td colspan="6" height="1"><img src="templates/master_template/images/spacer.gif" width="1" height="1"></td>

  </tr>  
  <tr bgcolor="#000000">
    <td width="31" height="1"><img src="templates/master_template/images/spacer.gif" width="31" height="1"></td>
    <td   colspan="4"><img src="templates/master_template/images/spacer.gif" width="250" height="1"></td>
    
    <td width="12" height="1"><img src="templates/master_template/images/spacer.gif" width="12" height="1"></td>

  </tr>
  <tr bgcolor="#000000">
    <td  align="right" width="31" height="20"><img src="templates/master_template/images/spacer.gif" width="31" height="20"></td>
    <td   align="left" colspan="2" ID="IEshout1"><img src="templates/master_template/images/spacer.gif" width="250" height="1"><br><div style="border-style: dotted1none; border-color:white" id=scroll3 dir=rtl ;overflow:auto>
{literal}
...
{/literal}
    ...
    <td ID="IEfad1" align="right" colspan="2"><img src="templates/master_template/images/spacer.gif" width="250" height="1"><br><div style="border-style: dotted1none; border-color:white" id=scroll3 dir=rtl ;overflow:auto>
{literal}
<SCRIPT LANGUAGE="JavaScript1.2" TYPE="text/javascript">
<!--
...
{/literal}
    ...
    <td><img src="templates/master_template/images/spacer.gif" width="12" height="20"></td>
  </tr>
  <tr bgcolor="#52ACEA">
...
.suckertreemenu .mainfoldericon{
	background: #3a3a3a url(templates/default_menu/images/arrow_down.gif) no-repeat center right;
}

/*Background image for subsequent level menu list links */
.suckertreemenu .subfoldericon{
	background: #3a3a3a url(templates/default_menu/images/arrow_right.gif) no-repeat center right;
}
...
{/if}
	...
	<li><a href="report.php">{$l_reports}</a>
		<ul>
			...
			<ul>
				<li><a href="planet_report.php?commandpage=commodities">{$l_planetstatus}</a></li>
				<li><a href="planet_report.php?commandpage=defenses">{$l_planetdefenses}</a></li>
				<li><a href="planet_report.php?commandpage=production_view">{$l_changeproduction}</a></li>
			</ul>
			</li>
...
{/php}
  ...
  <tr bgcolor="#2A2A2A">
    ...
    <td colspan="6" height="3"><img src="templates/master_template/images/spacer.gif" width="1" height="3"></td>
...
<tr bgcolor="#52ACEA">
    ...
    <td colspan="5" height="1"><img src="templates/master_template/images/spacer.gif" width="1" height="1"></td>
...
<div style="background: no-repeat top  right url(templates/default_menu/images/{$startypes}.gif) ;vertical-align: top; text-align: left; /*border: 1px solid white;*/">
<table width="100%" cellpadding=0 cellspacing=0 border=0 align=center>
<tr>
<td>&nbsp;</td>
<td>
...
<font color="white" size="2" face="arial"><b>{$galaxy_name}{if $beacon != ""}<br>{$beacon}{/if}</b></font>
</td><td align=right>
...
<tr><td class=normal>{$l_rank}: <img src="templates/default_menu/images/rank/{$insignia}"></td></tr>
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_energy}" src="templates/default_menu/images/energy.png">&nbsp;{$l_energy}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_fighters}" src="templates/default_menu/images/tfighter.png">&nbsp;<a href=defense_deploy.php>{$l_fighters}</a></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
{if $shipinfo_torps != "0"}
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_torps}" src="templates/default_menu/images/torp.png">&nbsp;<a href=defense_deploy.php>{$l_torps}</a></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
{if $shipinfo_armor != "0"}
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_armorpts}" src="templates/default_menu/images/armor.png">&nbsp;{$l_armor}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_credits}" src="templates/default_menu/images/credits.png">&nbsp;{$l_credits}</td><td width="50%" nowrap align='right' colspan=2><span class=mnu>&nbsp;
{php}
...
<table border="1" cellspacing="0" cellpadding="0" align="left" bordercolor="#52ACEA" style="border-color: 52ACEA; border-right-width: thin; border-left-width: thin; border-bottom-width: thin; border-top-width: thin;"><tr><td><table  border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#000000" width="175">
  ...
  <tr>
    <td><img src="templates/master_template/images/spacer.gif" width="10" height="21"></td>
...
<a class=mnu href="javascript:OpenSB()">{$shoutboxtitle}</a>
  ...
  <tr>
	...
	<input type="Text" name="sbt"  class="shoutform" size="20" maxlength="250" onfocus="document.onkeypress = null;" ONBLUR="document.onkeypress = getKey;" ><input type="submit" name="go" value="Go" class="shoutform"><br>{$l_public}&nbsp;
...
<tr align="center"><td>
<a href=port.php><img src="images/ports/port_{$port_type}.gif" border="0" alt="{$port_type} port" onMouseover="ddrivetip('{$portname}','{$port_description}');" onMouseout="hideddrivetip()"><br></a>{$portname}
</td>
	{if $sector_location == 1}
		<td><a href="casino.php?casinogame=casino_forums"><img src="images/ports/port_fedinfo.gif" border="0" alt="" onMouseover="ddrivetip('{$l_fedinfo}','{$l_infoport_description}');" onMouseout="hideddrivetip()"></a><br><br><b><font color=#33ff00>{$l_fedinfo}</font></b></td>
	{/if}
</tr>
</table>
...
{ for start=0 stop=$countplanet step=1 value=i }
	...
	{insert name="img" src="templates/default_menu/images/planet`$planetimg[$i]`.png" alt="" width="100" height="100"}
		...
		{if $playercount != 0}
			{for start=0 stop=$playercount-1 step=1 value=myLoop}
   				{if $shipprobe[$myLoop] == "ship"}
					...
					<img src="templates/default_menu/images/{$shipimage[$myLoop]}.gif" border=0></a><BR>
					{$shipnames[$myLoop]}
...
{php}
	...
	for($i = 0; $i < $defensecount; $i++){
		if($defensetype[$i] == "fighters"){
			if($count == 0){
				echo "<td align=center valign=top><img src=templates/default_menu/images/fighters.gif><br>";
			}
...
{php}
	...
	for($i = 0; $i < $defensecount; $i++){
		if($defensetype[$i] == "mines"){
			if($count == 0){
				echo "<td align=center valign=top><img src=templates/default_menu/images/mines.gif><br>";
			}
			echo " <font class=normal>";
			echo "<a class=mnu href=defense_modify.php?defense_id=" . $defenseid[$i] . ">";
			echo $defplayername[$i];
...
{if $xyminusp[4] != ""}
	...
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
	<TD bgcolor=black rowspan="3" valign="bottom"><img src="templates/default_menu/images/nav_vert.gif"  border=0 width = "12" height = "36"></td>
{if $xyplus[4] != ""}
...
<tr bgcolor=black><td colspan="3" valign="middle" align="right"><img src="templates/default_menu/images/nav_horz.gif"  border=0 width = "48" height = "12"></td><td border=1 valign="middle" align="center"><A HREF="#" onMouseover="ddrivetip('{$l_sector}: {$sector}','{$l_galacticarm}: {$ship_galacticarm}<br><br>{php} $coords = explode("|", $ship_coordinates); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]"{/php}');" onMouseout="hideddrivetip()"><img src="images/ports/yourhere.gif" border="0"></a></td><td colspan="3" align="left" valign="middle"><img src="templates/default_menu/images/nav_horz.gif"  border=0 width = "48" height = "12"></td></tr>
<tr>
{if $xyminus[4] != ""}
...
{if $xyminus[0] != ""}
	...
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
	<TD bgcolor=black rowspan="3" valign="top"><img src="templates/default_menu/images/nav_vert.gif"  border=0 width = "12" height = "36"></td>
{if $xyplusm[0] != ""}
