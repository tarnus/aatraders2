...
<div style="background: no-repeat top  right url(templates/default_menu_classic/images/{$startypes}.gif) ;vertical-align: top; text-align: left; /*border: 1px solid white;*/">
<table width="100%" cellpadding=0 cellspacing=0 border=0 align=center>
<tr>
<td>&nbsp;</td>
<td>
...
<tr><td class=normal>{$l_rank}: <img src="templates/default_menu_classic/images/rank/{$insignia}"></td></tr>
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_energy}" src="templates/default_menu_classic/images/energy.png">&nbsp;{$l_energy}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_fighters}" src="templates/default_menu_classic/images/tfighter.png">&nbsp;<a href=defense_deploy.php>{$l_fighters}</a></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
{if $shipinfo_torps != "0"}
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_torps}" src="templates/default_menu_classic/images/torp.png">&nbsp;<a href=defense_deploy.php>{$l_torps}</a></td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
{if $shipinfo_armor != "0"}
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_armorpts}" src="templates/default_menu_classic/images/armor.png">&nbsp;{$l_armor}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_credits}" src="templates/default_menu_classic/images/credits.png">&nbsp;{$l_credits}</td><td width="50%" nowrap align='right' colspan=2><span class=mnu>&nbsp;
{php}
...
<tr><td><br><table  border="0" cellspacing="0" cellpadding="0" align="left">
  ...
  <tr>
	...
	<input type="Text" name="sbt"  class="shoutform" size="20" maxlength="250" ONBLUR="document.onkeypress = getKey;" ONFOCUS="document.onkeypress = null;" ><input type="submit" name="go" value="Go" class="shoutform"><br>{$l_public}&nbsp;
...
{ for start=0 stop=$countplanet step=1 value=i }
	...
	{insert name="img" src="templates/default_menu_classic/images/planet`$planetimg[$i]`.png" alt="" width="100" height="100"}
		...
		{if $playercount != 0}
			{for start=0 stop=$playercount-1 step=1 value=myLoop}
   				{if $shipprobe[$myLoop] == "ship"}
					...
					<img src="templates/default_menu_classic/images/{$shipimage[$myLoop]}.gif" border=0></a><BR>
					{$shipnames[$myLoop]}
