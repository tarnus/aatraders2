...
<TR align="center"><TD><img src="images/avatars/{$avatar}"></td></tr>
		{/if}
<tr><td class=normal>{$l_rank}: <img src="templates/windowed/images/rank/{$insignia}"></td></tr>
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_energy}" src="templates/windowed/images/energy.png">&nbsp;{$l_energy}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_fighters}" src="templates/windowed/images/tfighter.png">&nbsp;{$l_fighters}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
{if $shipinfo_torps != "0"}
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_torps}" src="templates/windowed/images/torp.png">&nbsp;{$l_torps}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
{if $shipinfo_armor != "0"}
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_armorpts}" src="templates/windowed/images/armor.png">&nbsp;{$l_armor}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_credits}" src="templates/windowed/images/credits.png">&nbsp;{$l_credits}</td><td width="50%" nowrap align='right' colspan=2><span class=mnu>&nbsp;
{php}
      ...
      <table width="50%" border="0" cellspacing="3" cellpadding="3" align="{php} echo ($countplanet > 0) ? "right" : "center";{/php}">
        <tr> 
		  ...
		  {if $countplanet > 3}
			...
			{insert name="img" src="templates/windowed/images/planet`$planetimg[3]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[3]}
	...
	{/if}
        ...
        <tr> 
		  ...
		  {if $countplanet > 1}
			...
			{insert name="img" src="templates/windowed/images/planet`$planetimg[1]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[1]}
        ...
        <tr> 
		  ...
		  {if $countplanet > 0}
			...
			{insert name="img" src="templates/windowed/images/planet`$planetimg[0]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[0]}
        ...
        <tr> 
		  ...
		  {if $countplanet > 2}
			...
			{insert name="img" src="templates/windowed/images/planet`$planetimg[2]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[2]}
		  ...
		  {if $countplanet > 4}
			...
			{insert name="img" src="templates/windowed/images/planet`$planetimg[4]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[4]}
...
<img src="templates/windowed/images/{$startypes}.gif" border="0" alt="" style="position: absolute; z-index:-1; left: 90%; top: 30%; margin-left: -240px; margin-top: -140px;">
		...
		{if $playercount != 0}
			{for start=0 stop=$playercount-1 step=1 value=myLoop}
   				{if $shipprobe[$myLoop] == "ship"}
					...
					<img src="templates/windowed/images/{$shipimage[$myLoop]}.gif" border=0></a><BR>
					{$shipnames[$myLoop]}
