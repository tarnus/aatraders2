...
key['H'] = "templates/default_paged_classic/hotkeyhelp.php";
key['i'] = "igb.php";
key['L'] = "logout.php";
key['l'] = "log.php";
...
<tr>
	<td><img src="templates/default_paged_classic/images/topnav-left.gif" width="41" height="55"></td>
	<td background="templates/default_paged_classic/images/topnav-bg.gif" width="100%" height="55" ID="IEshout" align="center" valign="middle">
<layer id="shout"</layer>
	</td>
	<td><img src="templates/default_paged_classic/images/topnav-right.gif" width="22" height="55"></td>
</tr>
</table>
{/if}
<div style="background: no-repeat top  right url(templates/default_paged_classic/images/{$startypes}.gif) ;vertical-align: top; text-align: left; /*border: 1px solid white;*/">
...
<table width="195" border="0" cellspacing="0" cellpadding="0" align="left">
  <tr>
    <td><img src="templates/default_paged_classic/images/b-tbar-lt1.gif" width="23" height="13"></td>
    <td align="right" background="templates/default_paged_classic/images/b-tbar-bg.gif"><img src="templates/default_paged_classic/images/b-tbar-cnt.gif" width="143" height="13"></td>
    <td><img src="templates/default_paged_classic/images/b-tbar-rt.gif" width="29" height="13"></td>
  </tr>
  <tr>
    <td><img src="templates/default_paged_classic/images/b-tbar-ls.gif" width="23" height="21"></td>
    <td bgcolor="#000000"><img src="templates/master_template/images/spacer.gif" width="143" height="21"></td>
    <td><img src="templates/default_paged_classic/images/b-tbar-rs.gif" width="29" height="21"></td>
  </tr>
  <tr>
    <td background="templates/default_paged_classic/images/b-lbar-bg.gif">&nbsp;</td>
...
<TR align="center"><TD><img src="images/avatars/{$avatar}"></td></tr>
		{/if}
<tr><td class=normal>{$l_rank}: <img src="templates/default_paged_classic/images/rank/{$insignia}"></td></tr>
...
<tr><td class=normal>{$l_home_planet}: <span class=mnu>{$home_planet_name}</span></td></tr>
    ...
    <td background="templates/default_paged_classic/images/b-rbar.gif">&nbsp;</td>
  </tr>
  <tr>
    <td><img src="templates/default_paged_classic/images/b-bar-ls_01.gif" width="23" height="12"></td>
    <td background="templates/default_paged_classic/images/b-bar-bg.gif"></td>
    <td><img src="templates/default_paged_classic/images/b-bar-rs_03.gif" width="29" height="12"></td>
  </tr>
</table>
</td></tr>

<tr><td>
<img src="templates/master_template/images/spacer.gif" height="2">
</td></tr>
...
<table  border="0" cellspacing="0" cellpadding="0" align="left">
  ...
  <tr>
    <td><img src="templates/default_paged_classic/images/b-tbar-ls.gif" width="23" height="21"></td>
    <td bgcolor="#000000"><img src="templates/default_paged_classic/images/b-tbar-cmdtitle.gif" width="143" height="21"></td>
    <td><img src="templates/default_paged_classic/images/b-tbar-rs.gif" width="29" height="21"></td>
  </tr>
  <tr>
    <td background="templates/default_paged_classic/images/b-lbar-bg.gif">&nbsp;</td>
...
{if $galaxy_map_enabled == true and $gd_enabled == true}
	{$command3dmap}<br>
{/if}
&nbsp;<a class=mnu href="#" onClick="window.open('templates/default_paged_classic/hotkeyhelp.php','help','height=300,width=420,scrollbars=yes,resizable=no');">Hotkey Help</a><br>
{$commandfeedback}<br>
{if $link_forums != 0}
	{$commandforums}<br>
{/if}
...
<table  border="0" cellspacing="0" cellpadding="0" align="left">
  ...
  <tr>
    <td><img src="templates/default_paged_classic/images/b-tbar-ls.gif" width="23" height="21"></td>
    <td bgcolor="#000000"><img src="templates/default_paged_classic/images/b-tbar-sbtitle.gif" width="143" height="21"></td>
    <td><img src="templates/default_paged_classic/images/b-tbar-rs.gif" width="29" height="21"></td>
  </tr>
  <tr>
    <td background="templates/default_paged_classic/images/b-lbar-bg.gif">&nbsp;</td>
      ...
      <table width="50%" border="0" cellspacing="3" cellpadding="3" align="{php} echo ($countplanet > 0) ? "right" : "center";{/php}">
        <tr> 
		  ...
		  {if $countplanet > 3}
			...
			{insert name="img" src="templates/default_paged_classic/images/planet`$planetimg[3]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[3]}
	...
	{/if}
        ...
        <tr> 
		  ...
		  {if $countplanet > 1}
			...
			{insert name="img" src="templates/default_paged_classic/images/planet`$planetimg[1]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[1]}
        ...
        <tr> 
		  ...
		  {if $countplanet > 0}
			...
			{insert name="img" src="templates/default_paged_classic/images/planet`$planetimg[0]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[0]}
        ...
        <tr> 
		  ...
		  {if $countplanet > 2}
			...
			{insert name="img" src="templates/default_paged_classic/images/planet`$planetimg[2]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[2]}
		  ...
		  {if $countplanet > 4}
			...
			{insert name="img" src="templates/default_paged_classic/images/planet`$planetimg[4]`.png" alt="" width="100" height="100"}
			</a><BR>
			<b>{$planetname[4]}
		...
		{if $playercount != 0}
			{for start=0 stop=$playercount-1 step=1 value=myLoop}
   				{if $shipprobe[$myLoop] == "ship"}
					...
					<img src="templates/default_paged_classic/images/{$shipimage[$myLoop]}.gif" border=0></a><BR>
					{$shipnames[$myLoop]}
...
{php}
	...
	for($i = 0; $i < $defensecount; $i++){
		if($defensetype[$i] == "fighters"){
			if($count == 0){
				echo "<td align=center valign=top><img src=templates/default_paged_classic/images/fighters.gif><br>";
			}
	...
	for($i = 0; $i < $defensecount; $i++){
		if($defensetype[$i] == "mines"){
			if($count == 0){
				echo "<td align=center valign=top><img src=templates/default_paged_classic/images/mines.gif><br>";
			}
			echo " <font class=normal>";
			echo "<a class=mnu href=defense_modify.php?defense_id=" . $defenseid[$i] . "><b>";
			echo $defplayername[$i];
...
<table width="195" border="0" cellspacing="0" cellpadding="0" align="right">
  ...
  <tr>
    <td><img src="templates/default_paged_classic/images/b-tbar-ls.gif" width="23" height="21"></td>
    <td bgcolor="#000000"><img src="templates/default_paged_classic/images/b-tbar-cargo-title.gif" width="143" height="21"></td>
    <td><img src="templates/default_paged_classic/images/b-tbar-rs.gif" width="29" height="21"></td>
  </tr>
  <tr>
    <td background="templates/default_paged_classic/images/b-lbar-bg.gif">&nbsp;</td>
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_energy}" src="templates/default_paged_classic/images/energy.png">&nbsp;{$l_energy}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_fighters}" src="templates/default_paged_classic/images/tfighter.png">&nbsp;{$l_fighters}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
{if $shipinfo_torps != "0"}
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_torps}" src="templates/default_paged_classic/images/torp.png">&nbsp;{$l_torps}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
{if $shipinfo_armor != "0"}
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_armorpts}" src="templates/default_paged_classic/images/armor.png">&nbsp;{$l_armor}</td><td width="50%" nowrap align='right'><span class=mnu>&nbsp;
{php}
...
<tr><td width="50%" nowrap align='left' class=normal><img height=12 width=12 alt="{$l_credits}" src="templates/default_paged_classic/images/credits.png">&nbsp;{$l_credits}</td><td width="50%" nowrap align='right' colspan=2><span class=mnu>&nbsp;
{php}
...
<table width="195" border="0" cellspacing="0" cellpadding="0" align="right">
  ...
  <tr>
    <td><img src="templates/default_paged_classic/images/b-tbar-ls.gif" width="23" height="21"></td>
    <td bgcolor="#000000"><img src="templates/default_paged_classic/images/b-tbar-tr-title.gif" width="143" height="21"></td>
    <td><img src="templates/default_paged_classic/images/b-tbar-rs.gif" width="29" height="21"></td>
  </tr>
  <tr>
    <td background="templates/default_paged_classic/images/b-lbar-bg.gif">&nbsp;</td>
...
<table border="0" cellspacing="0" cellpadding="0" align="right">
  ...
  <tr>
    <td><img src="templates/default_paged_classic/images/b-tbar-ls.gif" width="23" height="21"></td>
    <td bgcolor="#000000"><img src="templates/default_paged_classic/images/b-tbar-rstitle.gif" width="143" height="21"></td>
    <td><img src="templates/default_paged_classic/images/b-tbar-rs.gif" width="29" height="21"></td>
  </tr>
  <tr>
    <td background="templates/default_paged_classic/images/b-lbar-bg.gif">&nbsp;</td>
...
{if $xyminusp[4] != ""}
	...
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}	
	<TD bgcolor=black rowspan="3" valign="bottom"><img src="templates/default_paged_classic/images/nav_vert.gif"  border=0 width = "12" height = "36"></td>
{if $xyplus[4] != ""}
...
<tr bgcolor=black><td colspan="3" valign="middle" align="right"><img src="templates/default_paged_classic/images/nav_horz.gif"  border=0 width = "48" height = "12"></td><td border=1 valign="middle" align="center"><A HREF="#" onMouseover="ddrivetip('{$l_sector}: {$sector}','{$l_galacticarm}: {$ship_galacticarm}<br><br>{php} $coords = explode("|", $ship_coordinates); echo "X: $coords[0]<br>Y: $coords[1]<br>Z: $coords[2]"{/php}');" onMouseout="hideddrivetip()"><img src="images/ports/yourhere.gif" border="0"></a></td><td colspan="3" align="left" valign="middle"><img src="templates/default_paged_classic/images/nav_horz.gif"  border=0 width = "48" height = "12"></td></tr>
<tr>
{if $xyminus[4] != ""}
...
{if $xyminus[0] != ""}
	...
	{else}
		<TD bgcolor="#585858"><img src="templates/master_template/images/spacer.gif"  border=0 width = "12" height = "12"></td>
	{/if}		
	<TD bgcolor=black rowspan="3" valign="top"><img src="templates/default_paged_classic/images/nav_vert.gif"  border=0 width = "12" height = "36"></td>
{if $xyplusm[0] != ""}
...
<table  border="0" cellspacing="0" cellpadding="0" align="right">
  ...
  <tr>
    <td><img src="templates/default_paged_classic/images/b-tbar-ls.gif" width="23" height="21"></td>
    <td bgcolor="#000000"><img src="templates/default_paged_classic/images/b-tbar-wttitle.gif" width="143" height="21"></td>
    <td><img src="templates/default_paged_classic/images/b-tbar-rs.gif" width="29" height="21"></td>
  </tr>
  <tr>
    <td background="templates/default_paged_classic/images/b-lbar-bg.gif">&nbsp;</td>
...
{if $show_newscrawl == 1}
<TABLE align="center" background="templates/default_paged_classic/images/topnav-mid.gif" height="55" width="492">
<tr>
	<td><img src="templates/master_template/images/spacer.gif" width="5"><td><TD align="center" height="50" width="100%" ID="IEnews">
<layer id="news"</layer>
{literal}
<SCRIPT LANGUAGE="JavaScript1.2" TYPE="text/javascript">
<!--
...
{/literal}
	</td><td><img src="templates/master_template/images/spacer.gif" width="5"></td>
</tr>
</table>
{/if}
