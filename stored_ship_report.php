...
while (!$result->EOF) {
	...
	$galaxylocation[$shipcount] = $galaxynames[$member['galaxy_id']];
	$galaxylocationgalaxy[$shipcount] = $member['galaxy_id'];
...
$template_object->display("master_template/stored-ship-report.tpl");
include ("footer.php");
die();
