...
switch ($command) {
	 case 1:	 // INFO on single team
		...
		$template_object->display("master_template/teams-info.tpl");
		break;
	 ...
	 case 2:	 // LEAVE
		...
		$template_object->assign("l_team_menu", $l_team_menu);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teams-leave.tpl");
		break;
	 ...
	 case 3: // JOIN
		...
		$template_object->assign("l_team_menu", $l_team_menu);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teams-join.tpl");
		break;
	 ...
	 case 4:
		...
		$template_object->assign("l_team_menu", $l_team_menu);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teams-cancelinvite.tpl");
		break;
	 ...
	 case 5: // Eject member
		...
		$template_object->assign("l_team_menu", $l_team_menu);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teams-ejectmember.tpl");
		break;
	 ...
	 case 6: // Create Team
		...
		$template_object->assign("l_team_menu", $l_team_menu);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teams-createteam.tpl");
		break;
	 ...
	 case 7: // INVITE player
		...
		$template_object->assign("l_team_menu", $l_team_menu);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teams-invite.tpl");
		break;
	 ...
	 case 8: // REFUSE invitation
		...
		$template_object->assign("l_team_menu", $l_team_menu);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teams-refuse.tpl");
		break;
	 ...
	 case 9: // Edit Team
		...
		$template_object->assign("l_team_menu", $l_team_menu);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teams-edit.tpl");
		break;
	 ...
	 default:
		if (!$thisplayer_info['team']) {
			...
			if ($thisplayer_info['team'] < 0) {
				...
				$template_object->assign("l_team_menu", $l_team_menu);
				$template_object->assign("gotomain", $l_global_mmenu);
				$template_object->display("master_template/teams-reject.tpl");
				break;
			}
		...
		$template_object->assign("l_team_menu", $l_team_menu);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teams-default.tpl");
		break;
} // switch ($command)
