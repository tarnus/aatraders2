...
<form action="test_adodb_lite_sessions.php" method="POST" enctype="multipart/form-data">
	<table width="80%"  border="0" align="center" cellpadding="10" cellspacing="1">
      ...
      <tr>
		...
		<input type="hidden" name="USERID" value="<?php echo mt_rand(1,10000);?>">
  ...
  <tr>
    <td colspan="2" valign="middle"><div align="center">
      <p>
		...
		Encryption Method: <?php echo $encryption_name[$_POST['encrypt']];?><br>
		Compression Method: <?php echo $compression_name[$_POST['compress']];?><br>
      </p>
    </div></td>
  </tr>
  <tr>
