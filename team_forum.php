...
*/
		...
		$template_object->display("master_template/teamforum-showtopics.tpl");
		include ("footer.php");
		die();
	}
	...
	if($command == "posttopic"){
		...
		$template_object->assign("l_forums_showtopic", $l_forums_showtopic);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teamforum-posttopic.tpl");
		include ("footer.php");
		die();
	}
...
*/
		...
		$template_object->assign("l_forums_showtopic", $l_forums_showtopic);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teamforum-readtopic.tpl");
		include ("footer.php");
		die();
	}
	...
	if($command == "postreply"){
		...
		$template_object->assign("l_forums_showtopic", $l_forums_showtopic);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teamforum-postreply.tpl");
		include ("footer.php");
		die();
	}
	...
	if($command == "edit"){
		...
		$template_object->assign("l_forums_showtopic", $l_forums_showtopic);
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/teamforum-edit.tpl");
		include ("footer.php");
		die();
	}
	...
	$template_object->assign("l_forums_showtopic", $l_forums_showtopic);
	$template_object->assign("gotomain", $l_global_mmenu);
	$template_object->display("master_template/teamforum-die.tpl");
	include ("footer.php");
	die();
}
