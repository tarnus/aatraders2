...
//		echo "\n\n<!--" . $url . "-->\n\n";
		...
		if($result == "ok"){
			...
			$template_object->display("master_template/profile.tpl");
			include ("footer.php");
			die();
		}
		elseif($result == "bad")
		{
			...
			$template_object->assign("gotomain", $l_global_mmenu);
			$template_object->display("master_template/profile-bad.tpl");
			include ("footer.php");
			die();
		}
		else
	...
	else
	{
		...
		$template_object->assign("gotomain", $l_global_mmenu);
		$template_object->display("master_template/profile-register.tpl");
		include ("footer.php");
		die();
	}
}
